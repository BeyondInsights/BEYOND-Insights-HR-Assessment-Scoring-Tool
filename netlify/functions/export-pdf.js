...
exports.handler = async (event) => {
  ...
  try {
    ...
    // ==========================================
    // SLIDE 1: Title + Executive Summary + X Points Away (ALL ON PAGE 1)
    // ==========================================
