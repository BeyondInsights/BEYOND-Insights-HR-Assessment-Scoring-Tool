...
// Uses Browserless to render the PPT slides as PDF - looks identical to PowerPoint
...
exports.handler = async (event) => {
  try {
    ...
    // Render the PPT slides as PDF - same as PowerPoint export but PDF format
    const reportUrl = `${origin}/admin/reports/${encodeURIComponent(surveyId)}?export=1&mode=landscapepdf`;
    console.log('Generating PDF from PPT slides:', reportUrl);
