...
const ELEMENT_WEIGHTS: Record<number, Record<string, number>> = {
  1: {
    'Job protection beyond local / legal requirements': 0.207879,
    'Disability pay top-up (employer adds to disability insurance)': 0.195265,
    'Intermittent leave beyond local / legal requirements': 0.106473,
    'Leave donation bank (employees can donate PTO to colleagues)': 0.103649,
    'Emergency leave within 24 hours': 0.095274,
    'Flexible work hours during treatment (e.g., varying start/end times, compressed schedules)': 0.051788,
    'Paid micro-breaks for medical-related side effects': 0.050694,
    'PTO accrual during leave': 0.047245,
    'Paid medical leave beyond local / legal requirements': 0.047245,
    'Reduced schedule/part-time with full benefits': 0.047245,
    'Remote work options for on-site employees': 0.047245,
  },
  2: {
  ...
  13: {
    'Dedicated program website or portal': 0.220535,
    'New hire orientation coverage': 0.135912,
    'Ability to access program information and resources anonymously': 0.127269,
    'Manager toolkit for cascade communications': 0.087356,
    'Employee testimonials/success stories': 0.085786,
    'Family/caregiver communication inclusion': 0.085786,
    'Multi-channel communication strategy': 0.085786,
    'Proactive communication at point of diagnosis disclosure': 0.085786,
    'Regular company-wide awareness campaigns (at least quarterly)': 0.085786,
  },
};
...
const DIMENSIONS: Record<number, DimensionData> = {
  1: {
    ...
    items: [
      { rank: 1, name: "Job protection beyond local / legal requirements", weight: 0.207879, equal: 0.090909, delta: 0.11697, stability: 1.0 },
      { rank: 2, name: "Disability pay top-up (employer adds to disability insurance)", weight: 0.195265, equal: 0.090909, delta: 0.104356, stability: 0.995 },
      { rank: 3, name: "Intermittent leave beyond local / legal requirements", weight: 0.106473, equal: 0.090909, delta: 0.015564, stability: 0.97 },
      { rank: 4, name: "Leave donation bank (employees can donate PTO to colleagues)", weight: 0.103649, equal: 0.090909, delta: 0.01274, stability: 0.96 },
      { rank: 5, name: "Emergency leave within 24 hours", weight: 0.095274, equal: 0.090909, delta: 0.004365, stability: 0.94 },
      { rank: 6, name: "Flexible work hours during treatment (e.g., varying start/end times...", weight: 0.051788, equal: 0.090909, delta: -0.039121, stability: 0.77 },
      { rank: 7, name: "Paid micro-breaks for medical-related side effects", weight: 0.050694, equal: 0.090909, delta: -0.040215, stability: 0.73 },
      { rank: 8, name: "PTO accrual during leave", weight: 0.047245, equal: 0.090909, delta: -0.043664, stability: 0.0 },
      { rank: 9, name: "Paid medical leave beyond local / legal requirements", weight: 0.047245, equal: 0.090909, delta: -0.043664, stability: 0.0 },
      { rank: 10, name: "Reduced schedule/part-time with full benefits", weight: 0.047245, equal: 0.090909, delta: -0.043664, stability: 0.0 },
      { rank: 11, name: "Remote work options for on-site employees", weight: 0.047245, equal: 0.090909, delta: -0.043664, stability: 0.0 },
    ]
  },
  2: {
  ...
  13: {
    ...
    items: [
      { rank: 1, name: "Dedicated program website or portal", weight: 0.220535, equal: 0.111111, delta: 0.109424, stability: 0.875 },
      { rank: 2, name: "New hire orientation coverage", weight: 0.135912, equal: 0.111111, delta: 0.024801, stability: 0.715 },
      { rank: 3, name: "Ability to access program information and resources anonymously", weight: 0.127269, equal: 0.111111, delta: 0.016158, stability: 0.75 },
      { rank: 4, name: "Manager toolkit for cascade communications", weight: 0.087356, equal: 0.111111, delta: -0.023755, stability: 0.595 },
      { rank: 5, name: "Employee testimonials/success stories", weight: 0.085786, equal: 0.111111, delta: -0.025325, stability: 0.0 },
      { rank: 6, name: "Family/caregiver communication inclusion", weight: 0.085786, equal: 0.111111, delta: -0.025325, stability: 0.0 },
      { rank: 7, name: "Multi-channel communication strategy", weight: 0.085786, equal: 0.111111, delta: -0.025325, stability: 0.0 },
      { rank: 8, name: "Proactive communication at point of diagnosis disclosure", weight: 0.085786, equal: 0.111111, delta: -0.025325, stability: 0.0 },
      { rank: 9, name: "Regular company-wide awareness campaigns (at least quarterly)", weight: 0.085786, equal: 0.111111, delta: -0.025325, stability: 0.0 },
    ]
  },
};
