...
interface ElementItem { rank: number; name: string; weight: number; equal: number; delta: number; stability: string; }
...
const ELEMENT_WEIGHTS: Record<number, Record<string, number>> = {
  1: {
    'Disability pay top-up (employer adds to disability insurance)': 0.210253,
    'Job protection beyond local / legal requirements': 0.210253,
    'Intermittent leave beyond local / legal requirements': 0.112512,
    'Leave donation bank (employees can donate PTO to colleagues)': 0.089071,
    'Emergency leave within 24 hours': 0.086067,
    'Flexible work hours during treatment (e.g., varying start/end times, compressed schedules)': 0.051177,
    'Paid micro-breaks for medical-related side effects': 0.049529,
    'PTO accrual during leave': 0.047785,
    'Paid medical leave beyond local / legal requirements': 0.047785,
    'Reduced schedule/part-time with full benefits': 0.047785,
    'Remote work options for on-site employees': 0.047785,
  },
  2: {
    'Set out-of-pocket maximums (for in-network single coverage)': 0.195961,
    'Short-term disability covering 60%+ of salary': 0.172842,
    'Insurance advocacy/pre-authorization support': 0.087942,
    'Voluntary supplemental illness insurance (with employer contribution)': 0.071275,
    'Long-term disability covering 60%+ of salary': 0.065440,
    'Financial counseling services': 0.064602,
    'Real-time cost estimator tools': 0.040027,
    'Guaranteed job protection': 0.033976,
    'Hardship grants program funded by employer': 0.030793,
    'Tax/estate planning assistance': 0.030690,
    'Paid time off for clinical trial participation': 0.029834,
    'Employer-paid disability insurance supplements': 0.029559,
  ...
  3: {
    'Dedicated manager resource hub': 0.238662,
    'Legal compliance training': 0.238662,
    'Privacy protection and confidentiality management': 0.081182,
    'Empathy/communication skills training': 0.077121,
    'Senior leader coaching on supporting impacted employees': 0.064081,
    'Manager training on supporting employees managing cancer or other serious health conditions/illnesses and their teams': 0.061629,
    'AI-powered guidance tools': 0.059665,
    'Clear escalation protocol for manager response': 0.059665,
    'Manager peer support / community building': 0.059665,
    'Manager evaluations include how well they support impacted employees': 0.059665,
  },
  4: {
    'Survivorship planning assistance': 0.209917,
    'Physical rehabilitation support': 0.124987,
    'Online tools, apps, or portals for health/benefits support': 0.119403,
    'Dedicated navigation support to help employees understand benefits and access medical care': 0.090033,
    'Clinical trial matching service': 0.079925,
    'Insurance advocacy/appeals support': 0.078438,
    'Care coordination concierge': 0.076051,
    'Nutrition coaching': 0.074304,
    'Occupational therapy/vocational rehabilitation': 0.073471,
    'Benefits optimization assistance (maximizing coverage, minimizing costs)': 0.073471,
  },
  5: {
    'Transportation reimbursement': 0.206470,
    'Flexible scheduling options': 0.132062,
    'Cognitive / fatigue support tools': 0.098380,
    'Ergonomic equipment funding': 0.085234,
    'Rest areas / quiet spaces': 0.077497,
    'Priority parking': 0.068987,
    'Remote work capability': 0.068517,
    'Assistive technology catalog': 0.065768,
    'Physical workspace modifications': 0.065695,
    'Policy accommodations (e.g., dress code flexibility, headphone use)': 0.065695,
    'Temporary role redesigns': 0.065695,
  },
  6: {
    'Specialized emotional counseling': 0.231431,
    'Clear process for confidential health disclosures': 0.144902,
    'Professional-led support groups (external facilitator/counselor)': 0.104258,
    'Stigma-reduction initiatives': 0.097940,
    'Inclusive communication guidelines': 0.061732,
    'Confidential HR channel for health benefits, policies and insurance-related questions': 0.058031,
    'Written anti-retaliation policies for health disclosures': 0.056607,
    'Optional open health dialogue forums': 0.051409,
    'Anonymous benefits navigation tool or website (no login required)': 0.048863,
    'Employee peer support groups (internal employees with shared experience)': 0.048397,
    'Manager training on handling sensitive health information': 0.048215,
    'Strong anti-discrimination policies specific to health conditions': 0.048215,
  },
  7: {
    'Succession planning protections': 0.232478,
    'Professional coach/mentor for employees managing cancer or other serious health conditions': 0.185074,
    'Peer mentorship program (employees who had similar condition mentoring current employees)': 0.135480,
    'Career coaching for employees managing cancer or other serious health conditions': 0.087313,
    'Optional stay-connected program': 0.086566,
    'Continued access to training/development': 0.077452,
    'Adjusted performance goals/deliverables during treatment and recovery': 0.066482,
    'Project continuity protocols': 0.064577,
    'Structured reintegration programs': 0.064577,
  },
  8: {
    'Structured progress reviews': 0.211655,
    'Workload adjustments during treatment': 0.139881,
    'Long-term success tracking': 0.104547,
    'Phased return-to-work plans': 0.084602,
    'Manager training on supporting team members during treatment/return': 0.069433,
    'Access to specialized work resumption professionals': 0.062015,
    'Online peer support forums': 0.060839,
    'Flexible work arrangements during treatment': 0.055372,
    'Flexibility for medical setbacks': 0.052914,
    'Access to occupational therapy/vocational rehabilitation': 0.052914,
    'Buddy/mentor pairing for support': 0.052914,
    'Contingency planning for treatment schedules': 0.052914,
  },
  9: {
    'Compensation tied to support outcomes': 0.202464,
    'Dedicated budget allocation for serious illness support programs': 0.172214,
    'Support programs included in investor/stakeholder communications': 0.142605,
    'Cross-functional executive steering committee for workplace support programs': 0.097367,
    'C-suite executive serves as program champion/sponsor': 0.070763,
    'ESG/CSR reporting inclusion': 0.061092,
    'Year-over-year budget growth': 0.059231,
    'Executive accountability metrics': 0.052934,
    'Support metrics included in annual report/sustainability reporting': 0.048708,
    'Public success story celebrations': 0.046524,
    'Executive sponsors communicate regularly about workplace support programs': 0.046099,
  },
  10: {
    'Paid time off for care coordination appointments': 0.171690,
    'Dependent care account matching/contributions': 0.155997,
    'Emergency dependent care when regular arrangements unavailable': 0.138030,
    'Practical support for managing caregiving and work': 0.057630,
    'Caregiver resource navigator/concierge': 0.050275,
    'Flexible work arrangements for caregivers': 0.048863,
    'Paid caregiver leave with expanded eligibility (beyond local legal requirements)': 0.040295,
    'Mental health support specifically for caregivers': 0.035868,
    'Unpaid leave job protection beyond local / legal requirements': 0.032494,
    'Manager training for supervising caregivers': 0.028939,
    'Expanded caregiver leave eligibility beyond legal definitions (e.g., siblings, in-laws, chosen family)': 0.028164,
    'Modified job duties during peak caregiving periods': 0.027427,
    'Respite care funding/reimbursement': 0.026431,
  ...
  11: {
    'Risk factor tracking/reporting': 0.187917,
    'Workplace safety assessments to minimize health risks': 0.176670,
    'Regular health education sessions': 0.124446,
    'Paid time off for preventive care appointments': 0.121173,
    'Genetic screening/counseling': 0.073584,
    'On-site vaccinations': 0.041641,
    'Lifestyle coaching programs': 0.041249,
    'Legal protections beyond requirements': 0.040828,
    'Full or partial coverage for annual health screenings/checkups': 0.038645,
  ...
  12: {
    'External benchmarking': 0.224979,
    'Program utilization analytics': 0.224979,
    'Regular program enhancements': 0.183774,
    'Innovation pilots': 0.085045,
    'Employee satisfaction tracking': 0.070306,
    'Employee confidence in employer support': 0.070306,
    'Business impact/ROI assessment': 0.070306,
    'Return-to-work success metrics': 0.070306,
  },
  13: {
    'Dedicated program website or portal': 0.216568,
    'Ability to access program information and resources anonymously': 0.142040,
    'New hire orientation coverage': 0.133645,
    'Manager toolkit for cascade communications': 0.086642,
    'Family/caregiver communication inclusion': 0.084221,
    'Employee testimonials/success stories': 0.084221,
    'Multi-channel communication strategy': 0.084221,
    'Proactive communication at point of diagnosis disclosure': 0.084221,
    'Regular company-wide awareness campaigns (at least quarterly)': 0.084221,
  },
};
...
const DIMENSIONS: Record<number, DimensionData> = {
  1: {
    ...
    items: [
      { rank: 1, name: "Disability pay top-up (employer adds to disability insurance)", weight: 0.210253, equal: 0.090909, delta: 0.119343, stability: "Strong" },
      { rank: 2, name: "Job protection beyond local / legal requirements", weight: 0.210253, equal: 0.090909, delta: 0.119343, stability: "Strong" },
      { rank: 3, name: "Intermittent leave beyond local / legal requirements", weight: 0.112512, equal: 0.090909, delta: 0.021603, stability: "Strong" },
      { rank: 4, name: "Leave donation bank (employees can donate PTO to colleagues)", weight: 0.089071, equal: 0.090909, delta: -0.001838, stability: "Solid" },
      { rank: 5, name: "Emergency leave within 24 hours", weight: 0.086067, equal: 0.090909, delta: -0.004842, stability: "Solid" },
      { rank: 6, name: "Flexible work hours during treatment (e.g., varying start/end times...", weight: 0.051177, equal: 0.090909, delta: -0.039732, stability: "Moderate" },
      { rank: 7, name: "Paid micro-breaks for medical-related side effects", weight: 0.049529, equal: 0.090909, delta: -0.04138, stability: "Moderate" },
      { rank: 8, name: "PTO accrual during leave", weight: 0.047785, equal: 0.090909, delta: -0.043124, stability: "Lower" },
      { rank: 9, name: "Paid medical leave beyond local / legal requirements", weight: 0.047785, equal: 0.090909, delta: -0.043124, stability: "Lower" },
      { rank: 10, name: "Reduced schedule/part-time with full benefits", weight: 0.047785, equal: 0.090909, delta: -0.043124, stability: "Lower" },
      { rank: 11, name: "Remote work options for on-site employees", weight: 0.047785, equal: 0.090909, delta: -0.043124, stability: "Lower" },
    ]
  },
  2: {
    ...
    items: [
      { rank: 1, name: "Set out-of-pocket maximums (for in-network single coverage)", weight: 0.195961, equal: 0.058824, delta: 0.137137, stability: "Strong" },
      { rank: 2, name: "Short-term disability covering 60%+ of salary", weight: 0.172842, equal: 0.058824, delta: 0.114019, stability: "Strong" },
      { rank: 3, name: "Insurance advocacy/pre-authorization support", weight: 0.087942, equal: 0.058824, delta: 0.029119, stability: "Strong" },
      { rank: 4, name: "Voluntary supplemental illness insurance (with employer contribution)", weight: 0.071275, equal: 0.058824, delta: 0.012451, stability: "Strong" },
      { rank: 5, name: "Long-term disability covering 60%+ of salary", weight: 0.065440, equal: 0.058824, delta: 0.006616, stability: "Strong" },
      { rank: 6, name: "Financial counseling services", weight: 0.064602, equal: 0.058824, delta: 0.005778, stability: "Strong" },
      { rank: 7, name: "Real-time cost estimator tools", weight: 0.040027, equal: 0.058824, delta: -0.018797, stability: "Strong" },
      { rank: 8, name: "Guaranteed job protection", weight: 0.033976, equal: 0.058824, delta: -0.024848, stability: "Moderate" },
      { rank: 9, name: "Hardship grants program funded by employer", weight: 0.030793, equal: 0.058824, delta: -0.02803, stability: "Moderate" },
      { rank: 10, name: "Tax/estate planning assistance", weight: 0.030690, equal: 0.058824, delta: -0.028133, stability: "Lower" },
      { rank: 11, name: "Paid time off for clinical trial participation", weight: 0.029834, equal: 0.058824, delta: -0.028989, stability: "Lower" },
      { rank: 12, name: "Employer-paid disability insurance supplements", weight: 0.029559, equal: 0.058824, delta: -0.029264, stability: "Lower" },
      { rank: 13, name: "$0 copay for specialty drugs", weight: 0.029412, equal: 0.058824, delta: -0.029412, stability: "Lower" },
      { rank: 14, name: "Accelerated life insurance benefits (partial payout for terminal / ...", weight: 0.029412, equal: 0.058824, delta: -0.029412, stability: "Lower" },
      { rank: 15, name: "Coverage for advanced therapies (CAR-T, proton therapy, immunothera...", weight: 0.029412, equal: 0.058824, delta: -0.029412, stability: "Lower" },
      { rank: 16, name: "Coverage for clinical trials and experimental treatments not covere...", weight: 0.029412, equal: 0.058824, delta: -0.029412, stability: "Lower" },
      { rank: 17, name: "Travel/lodging reimbursement for specialized care beyond insurance ...", weight: 0.029412, equal: 0.058824, delta: -0.029412, stability: "Lower" },
    ]
  },
  3: {
    ...
    items: [
      { rank: 1, name: "Dedicated manager resource hub", weight: 0.238662, equal: 0.100000, delta: 0.138662, stability: "Strong" },
      { rank: 2, name: "Legal compliance training", weight: 0.238662, equal: 0.100000, delta: 0.138662, stability: "Strong" },
      { rank: 3, name: "Privacy protection and confidentiality management", weight: 0.081182, equal: 0.100000, delta: -0.018818, stability: "Strong" },
      { rank: 4, name: "Empathy/communication skills training", weight: 0.077121, equal: 0.100000, delta: -0.022879, stability: "Strong" },
      { rank: 5, name: "Senior leader coaching on supporting impacted employees", weight: 0.064081, equal: 0.100000, delta: -0.035919, stability: "Solid" },
      { rank: 6, name: "Manager training on supporting employees managing cancer or other s...", weight: 0.061629, equal: 0.100000, delta: -0.038371, stability: "Moderate" },
      { rank: 7, name: "AI-powered guidance tools", weight: 0.059665, equal: 0.100000, delta: -0.040335, stability: "Moderate" },
      { rank: 8, name: "Clear escalation protocol for manager response", weight: 0.059665, equal: 0.100000, delta: -0.040335, stability: "Lower" },
      { rank: 9, name: "Manager peer support / community building", weight: 0.059665, equal: 0.100000, delta: -0.040335, stability: "Lower" },
      { rank: 10, name: "Manager evaluations include how well they support impacted employees", weight: 0.059665, equal: 0.100000, delta: -0.040335, stability: "Lower" },
    ]
  },
  4: {
    ...
    items: [
      { rank: 1, name: "Survivorship planning assistance", weight: 0.209917, equal: 0.100000, delta: 0.109917, stability: "Strong" },
      { rank: 2, name: "Physical rehabilitation support", weight: 0.124987, equal: 0.100000, delta: 0.024987, stability: "Solid" },
      { rank: 3, name: "Online tools, apps, or portals for health/benefits support", weight: 0.119403, equal: 0.100000, delta: 0.019403, stability: "Strong" },
      { rank: 4, name: "Dedicated navigation support to help employees understand benefits ...", weight: 0.090033, equal: 0.100000, delta: -0.009967, stability: "Solid" },
      { rank: 5, name: "Clinical trial matching service", weight: 0.079925, equal: 0.100000, delta: -0.020075, stability: "Solid" },
      { rank: 6, name: "Insurance advocacy/appeals support", weight: 0.078438, equal: 0.100000, delta: -0.021562, stability: "Moderate" },
      { rank: 7, name: "Care coordination concierge", weight: 0.076051, equal: 0.100000, delta: -0.023949, stability: "Moderate" },
      { rank: 8, name: "Nutrition coaching", weight: 0.074304, equal: 0.100000, delta: -0.025696, stability: "Moderate" },
      { rank: 9, name: "Occupational therapy/vocational rehabilitation", weight: 0.073471, equal: 0.100000, delta: -0.026529, stability: "Lower" },
      { rank: 10, name: "Benefits optimization assistance (maximizing coverage, minimizing c...", weight: 0.073471, equal: 0.100000, delta: -0.026529, stability: "Lower" },
    ]
  },
  5: {
    ...
    items: [
      { rank: 1, name: "Transportation reimbursement", weight: 0.206470, equal: 0.090909, delta: 0.115561, stability: "Strong" },
      { rank: 2, name: "Flexible scheduling options", weight: 0.132062, equal: 0.090909, delta: 0.041153, stability: "Strong" },
      { rank: 3, name: "Cognitive / fatigue support tools", weight: 0.098380, equal: 0.090909, delta: 0.007471, stability: "Strong" },
      { rank: 4, name: "Ergonomic equipment funding", weight: 0.085234, equal: 0.090909, delta: -0.005675, stability: "Solid" },
      { rank: 5, name: "Rest areas / quiet spaces", weight: 0.077497, equal: 0.090909, delta: -0.013412, stability: "Solid" },
      { rank: 6, name: "Priority parking", weight: 0.068987, equal: 0.090909, delta: -0.021923, stability: "Moderate" },
      { rank: 7, name: "Remote work capability", weight: 0.068517, equal: 0.090909, delta: -0.022392, stability: "Moderate" },
      { rank: 8, name: "Assistive technology catalog", weight: 0.065768, equal: 0.090909, delta: -0.025141, stability: "Lower" },
      { rank: 9, name: "Physical workspace modifications", weight: 0.065695, equal: 0.090909, delta: -0.025214, stability: "Lower" },
      { rank: 10, name: "Policy accommodations (e.g., dress code flexibility, headphone use)", weight: 0.065695, equal: 0.090909, delta: -0.025214, stability: "Lower" },
      { rank: 11, name: "Temporary role redesigns", weight: 0.065695, equal: 0.090909, delta: -0.025214, stability: "Lower" },
    ]
  },
  6: {
    ...
    items: [
      { rank: 1, name: "Specialized emotional counseling", weight: 0.231431, equal: 0.083333, delta: 0.148098, stability: "Strong" },
      { rank: 2, name: "Clear process for confidential health disclosures", weight: 0.144902, equal: 0.083333, delta: 0.061568, stability: "Strong" },
      { rank: 3, name: "Professional-led support groups (external facilitator/counselor)", weight: 0.104258, equal: 0.083333, delta: 0.020925, stability: "Strong" },
      { rank: 4, name: "Stigma-reduction initiatives", weight: 0.097940, equal: 0.083333, delta: 0.014607, stability: "Strong" },
      { rank: 5, name: "Inclusive communication guidelines", weight: 0.061732, equal: 0.083333, delta: -0.021601, stability: "Moderate" },
      { rank: 6, name: "Confidential HR channel for health benefits, policies and insurance...", weight: 0.058031, equal: 0.083333, delta: -0.025303, stability: "Solid" },
      { rank: 7, name: "Written anti-retaliation policies for health disclosures", weight: 0.056607, equal: 0.083333, delta: -0.026726, stability: "Solid" },
      { rank: 8, name: "Optional open health dialogue forums", weight: 0.051409, equal: 0.083333, delta: -0.031925, stability: "Moderate" },
      { rank: 9, name: "Anonymous benefits navigation tool or website (no login required)", weight: 0.048863, equal: 0.083333, delta: -0.03447, stability: "Moderate" },
      { rank: 10, name: "Employee peer support groups (internal employees with shared experi...", weight: 0.048397, equal: 0.083333, delta: -0.034936, stability: "Lower" },
      { rank: 11, name: "Manager training on handling sensitive health information", weight: 0.048215, equal: 0.083333, delta: -0.035118, stability: "Lower" },
      { rank: 12, name: "Strong anti-discrimination policies specific to health conditions", weight: 0.048215, equal: 0.083333, delta: -0.035118, stability: "Lower" },
    ]
  },
  7: {
    ...
    items: [
      { rank: 1, name: "Succession planning protections", weight: 0.232478, equal: 0.111111, delta: 0.121367, stability: "Strong" },
      { rank: 2, name: "Professional coach/mentor for employees managing cancer or other se...", weight: 0.185074, equal: 0.111111, delta: 0.073963, stability: "Strong" },
      { rank: 3, name: "Peer mentorship program (employees who had similar condition mentor...", weight: 0.135480, equal: 0.111111, delta: 0.024369, stability: "Solid" },
      { rank: 4, name: "Career coaching for employees managing cancer or other serious heal...", weight: 0.087313, equal: 0.111111, delta: -0.023798, stability: "Moderate" },
      { rank: 5, name: "Optional stay-connected program", weight: 0.086566, equal: 0.111111, delta: -0.024545, stability: "Moderate" },
      { rank: 6, name: "Continued access to training/development", weight: 0.077452, equal: 0.111111, delta: -0.033659, stability: "Moderate" },
      { rank: 7, name: "Adjusted performance goals/deliverables during treatment and recovery", weight: 0.066482, equal: 0.111111, delta: -0.044629, stability: "Lower" },
      { rank: 8, name: "Project continuity protocols", weight: 0.064577, equal: 0.111111, delta: -0.046534, stability: "Lower" },
      { rank: 9, name: "Structured reintegration programs", weight: 0.064577, equal: 0.111111, delta: -0.046534, stability: "Lower" },
    ]
  },
  8: {
    ...
    items: [
      { rank: 1, name: "Structured progress reviews", weight: 0.211655, equal: 0.083333, delta: 0.128322, stability: "Strong" },
      { rank: 2, name: "Workload adjustments during treatment", weight: 0.139881, equal: 0.083333, delta: 0.056548, stability: "Strong" },
      { rank: 3, name: "Long-term success tracking", weight: 0.104547, equal: 0.083333, delta: 0.021214, stability: "Strong" },
      { rank: 4, name: "Phased return-to-work plans", weight: 0.084602, equal: 0.083333, delta: 0.001268, stability: "Solid" },
      { rank: 5, name: "Manager training on supporting team members during treatment/return", weight: 0.069433, equal: 0.083333, delta: -0.013901, stability: "Solid" },
      { rank: 6, name: "Access to specialized work resumption professionals", weight: 0.062015, equal: 0.083333, delta: -0.021318, stability: "Solid" },
      { rank: 7, name: "Online peer support forums", weight: 0.060839, equal: 0.083333, delta: -0.022494, stability: "Solid" },
      { rank: 8, name: "Flexible work arrangements during treatment", weight: 0.055372, equal: 0.083333, delta: -0.027961, stability: "Solid" },
      { rank: 9, name: "Flexibility for medical setbacks", weight: 0.052914, equal: 0.083333, delta: -0.030419, stability: "Lower" },
      { rank: 10, name: "Access to occupational therapy/vocational rehabilitation", weight: 0.052914, equal: 0.083333, delta: -0.030419, stability: "Lower" },
      { rank: 11, name: "Buddy/mentor pairing for support", weight: 0.052914, equal: 0.083333, delta: -0.030419, stability: "Lower" },
      { rank: 12, name: "Contingency planning for treatment schedules", weight: 0.052914, equal: 0.083333, delta: -0.030419, stability: "Lower" },
    ]
  },
  9: {
    ...
    items: [
      { rank: 1, name: "Compensation tied to support outcomes", weight: 0.202464, equal: 0.090909, delta: 0.111555, stability: "Strong" },
      { rank: 2, name: "Dedicated budget allocation for serious illness support programs", weight: 0.172214, equal: 0.090909, delta: 0.081305, stability: "Strong" },
      { rank: 3, name: "Support programs included in investor/stakeholder communications", weight: 0.142605, equal: 0.090909, delta: 0.051696, stability: "Solid" },
      { rank: 4, name: "Cross-functional executive steering committee for workplace support...", weight: 0.097367, equal: 0.090909, delta: 0.006458, stability: "Solid" },
      { rank: 5, name: "C-suite executive serves as program champion/sponsor", weight: 0.070763, equal: 0.090909, delta: -0.020146, stability: "Moderate" },
      { rank: 6, name: "ESG/CSR reporting inclusion", weight: 0.061092, equal: 0.090909, delta: -0.029818, stability: "Solid" },
      { rank: 7, name: "Year-over-year budget growth", weight: 0.059231, equal: 0.090909, delta: -0.031678, stability: "Moderate" },
      { rank: 8, name: "Executive accountability metrics", weight: 0.052934, equal: 0.090909, delta: -0.037976, stability: "Lower" },
      { rank: 9, name: "Support metrics included in annual report/sustainability reporting", weight: 0.048708, equal: 0.090909, delta: -0.042201, stability: "Lower" },
      { rank: 10, name: "Public success story celebrations", weight: 0.046524, equal: 0.090909, delta: -0.044385, stability: "Lower" },
      { rank: 11, name: "Executive sponsors communicate regularly about workplace support pr...", weight: 0.046099, equal: 0.090909, delta: -0.04481, stability: "Lower" },
    ]
  },
  10: {
    ...
    items: [
      { rank: 1, name: "Paid time off for care coordination appointments", weight: 0.171690, equal: 0.052632, delta: 0.119059, stability: "Strong" },
      { rank: 2, name: "Dependent care account matching/contributions", weight: 0.155997, equal: 0.052632, delta: 0.103366, stability: "Strong" },
      { rank: 3, name: "Emergency dependent care when regular arrangements unavailable", weight: 0.138030, equal: 0.052632, delta: 0.085398, stability: "Strong" },
      { rank: 4, name: "Practical support for managing caregiving and work", weight: 0.057630, equal: 0.052632, delta: 0.004999, stability: "Strong" },
      { rank: 5, name: "Caregiver resource navigator/concierge", weight: 0.050275, equal: 0.052632, delta: -0.002356, stability: "Solid" },
      { rank: 6, name: "Flexible work arrangements for caregivers", weight: 0.048863, equal: 0.052632, delta: -0.003768, stability: "Strong" },
      { rank: 7, name: "Paid caregiver leave with expanded eligibility (beyond local legal ...", weight: 0.040295, equal: 0.052632, delta: -0.012337, stability: "Solid" },
      { rank: 8, name: "Mental health support specifically for caregivers", weight: 0.035868, equal: 0.052632, delta: -0.016763, stability: "Solid" },
      { rank: 9, name: "Unpaid leave job protection beyond local / legal requirements", weight: 0.032494, equal: 0.052632, delta: -0.020137, stability: "Solid" },
      { rank: 10, name: "Manager training for supervising caregivers", weight: 0.028939, equal: 0.052632, delta: -0.023693, stability: "Solid" },
      { rank: 11, name: "Expanded caregiver leave eligibility beyond legal definitions (e.g....", weight: 0.028164, equal: 0.052632, delta: -0.024467, stability: "Moderate" },
      { rank: 12, name: "Modified job duties during peak caregiving periods", weight: 0.027427, equal: 0.052632, delta: -0.025205, stability: "Moderate" },
      { rank: 13, name: "Respite care funding/reimbursement", weight: 0.026431, equal: 0.052632, delta: -0.026201, stability: "Moderate" },
      { rank: 14, name: "Eldercare consultation and referral services", weight: 0.026316, equal: 0.052632, delta: -0.026316, stability: "Lower" },
      { rank: 15, name: "Caregiver peer support groups", weight: 0.026316, equal: 0.052632, delta: -0.026316, stability: "Lower" },
      { rank: 16, name: "Dependent care subsidies", weight: 0.026316, equal: 0.052632, delta: -0.026316, stability: "Lower" },
      { rank: 17, name: "Family navigation support", weight: 0.026316, equal: 0.052632, delta: -0.026316, stability: "Lower" },
      { rank: 18, name: "Legal/financial planning assistance for caregivers", weight: 0.026316, equal: 0.052632, delta: -0.026316, stability: "Lower" },
      { rank: 19, name: "Emergency caregiver funds", weight: 0.026316, equal: 0.052632, delta: -0.026316, stability: "Lower" },
    ]
  },
  11: {
    ...
    items: [
      { rank: 1, name: "Risk factor tracking/reporting", weight: 0.187917, equal: 0.076923, delta: 0.110994, stability: "Strong" },
      { rank: 2, name: "Workplace safety assessments to minimize health risks", weight: 0.176670, equal: 0.076923, delta: 0.099747, stability: "Strong" },
      { rank: 3, name: "Regular health education sessions", weight: 0.124446, equal: 0.076923, delta: 0.047522, stability: "Solid" },
      { rank: 4, name: "Paid time off for preventive care appointments", weight: 0.121173, equal: 0.076923, delta: 0.04425, stability: "Strong" },
      { rank: 5, name: "Genetic screening/counseling", weight: 0.073584, equal: 0.076923, delta: -0.003339, stability: "Solid" },
      { rank: 6, name: "On-site vaccinations", weight: 0.041641, equal: 0.076923, delta: -0.035282, stability: "Solid" },
      { rank: 7, name: "Lifestyle coaching programs", weight: 0.041249, equal: 0.076923, delta: -0.035674, stability: "Solid" },
      { rank: 8, name: "Legal protections beyond requirements", weight: 0.040828, equal: 0.076923, delta: -0.036096, stability: "Solid" },
      { rank: 9, name: "Full or partial coverage for annual health screenings/checkups", weight: 0.038645, equal: 0.076923, delta: -0.038278, stability: "Moderate" },
      { rank: 10, name: "Individual health assessments (online or in-person)", weight: 0.038462, equal: 0.076923, delta: -0.038462, stability: "Lower" },
      { rank: 11, name: "At least 70% coverage for regionally / locally recommended screenings", weight: 0.038462, equal: 0.076923, delta: -0.038462, stability: "Lower" },
      { rank: 12, name: "Policies to support immuno-compromised colleagues (e.g., mask proto...", weight: 0.038462, equal: 0.076923, delta: -0.038462, stability: "Lower" },
      { rank: 13, name: "Targeted risk-reduction programs", weight: 0.038462, equal: 0.076923, delta: -0.038462, stability: "Lower" },
    ]
  },
  12: {
    ...
    items: [
      { rank: 1, name: "External benchmarking", weight: 0.224979, equal: 0.125000, delta: 0.099979, stability: "Strong" },
      { rank: 2, name: "Program utilization analytics", weight: 0.224979, equal: 0.125000, delta: 0.099979, stability: "Strong" },
      { rank: 3, name: "Regular program enhancements", weight: 0.183774, equal: 0.125000, delta: 0.058774, stability: "Strong" },
      { rank: 4, name: "Innovation pilots", weight: 0.085045, equal: 0.125000, delta: -0.039955, stability: "Strong" },
      { rank: 5, name: "Employee satisfaction tracking", weight: 0.070306, equal: 0.125000, delta: -0.054694, stability: "Lower" },
      { rank: 6, name: "Employee confidence in employer support", weight: 0.070306, equal: 0.125000, delta: -0.054694, stability: "Lower" },
      { rank: 7, name: "Business impact/ROI assessment", weight: 0.070306, equal: 0.125000, delta: -0.054694, stability: "Lower" },
      { rank: 8, name: "Return-to-work success metrics", weight: 0.070306, equal: 0.125000, delta: -0.054694, stability: "Lower" },
    ]
  },
  13: {
    ...
    items: [
      { rank: 1, name: "Dedicated program website or portal", weight: 0.216568, equal: 0.111111, delta: 0.105457, stability: "Strong" },
      { rank: 2, name: "Ability to access program information and resources anonymously", weight: 0.142040, equal: 0.111111, delta: 0.030929, stability: "Strong" },
      { rank: 3, name: "New hire orientation coverage", weight: 0.133645, equal: 0.111111, delta: 0.022534, stability: "Solid" },
      { rank: 4, name: "Manager toolkit for cascade communications", weight: 0.086642, equal: 0.111111, delta: -0.024469, stability: "Moderate" },
      { rank: 5, name: "Family/caregiver communication inclusion", weight: 0.084221, equal: 0.111111, delta: -0.02689, stability: "Lower" },
      { rank: 6, name: "Employee testimonials/success stories", weight: 0.084221, equal: 0.111111, delta: -0.02689, stability: "Solid" },
      { rank: 7, name: "Multi-channel communication strategy", weight: 0.084221, equal: 0.111111, delta: -0.02689, stability: "Moderate" },
      { rank: 8, name: "Proactive communication at point of diagnosis disclosure", weight: 0.084221, equal: 0.111111, delta: -0.02689, stability: "Lower" },
      { rank: 9, name: "Regular company-wide awareness campaigns (at least quarterly)", weight: 0.084221, equal: 0.111111, delta: -0.02689, stability: "Lower" },
    ]
  },
};
...
function stabColor(tier: string): string {
  if (tier === 'Strong') return '#065F46';
  if (tier === 'Solid') return '#047857';
  if (tier === 'Moderate') return '#D97706';
  return '#9CA3AF';
}
function stabWidth(tier: string): number {
  if (tier === 'Strong') return 100;
  if (tier === 'Solid') return 72;
  if (tier === 'Moderate') return 48;
  return 24;
}
                              ...
                              <td className="px-3 py-2.5">
                                <div className="flex items-center justify-center gap-2">
                                  <div className="w-16 h-2 bg-slate-100 rounded-full overflow-hidden">
                                    <div className="h-full rounded-full" style={{ width: `${stabWidth(item.stability)}%`, backgroundColor: stabColor(item.stability) }} />
                                  </div>
                                  <span className={`text-xs font-medium w-16 text-right ${item.stability === 'Strong' ? 'text-emerald-800' : item.stability === 'Solid' ? 'text-emerald-700' : item.stability === 'Moderate' ? 'text-amber-700' : 'text-slate-400'}`}>{item.stability}</span>
                                </div>
                              </td>
                            </tr>
                          ))}
