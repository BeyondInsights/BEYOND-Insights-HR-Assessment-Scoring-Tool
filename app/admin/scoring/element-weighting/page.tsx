...
const ELEMENT_WEIGHTS: Record<number, Record<string, number>> = {
  1: {
    'Emergency leave within 24 hours': 0.143114,
    'Remote work options for on-site employees': 0.128729,
    'Intermittent leave beyond local / legal requirements': 0.113574,
    'Paid micro-breaks for side effects': 0.081779,
    'Flexible work hours during treatment (e.g., varying start/end times, compressed schedules)': 0.075997,
    'Job protection beyond local / legal requirements': 0.062303,
    'Paid medical leave beyond local / legal requirements': 0.058979,
    'Reduced schedule/part-time with full benefits': 0.057912,
    'Paid micro-breaks for medical-related side effects': 0.056012,
    'PTO accrual during leave': 0.05581,
    'Full salary (100%) continuation during cancer-related short-term disability leave': 0.055342,
    'Disability pay top-up (employer adds to disability insurance)': 0.055325,
    'Leave donation bank (employees can donate PTO to colleagues)': 0.055124,
  },
  2: {
    ...
    'Paid time off for clinical trial participation': 0.04334,
  ...
  3: {
    'Manager peer support / community building': 0.200023,
    'Manager training on supporting employees managing cancer or other serious health conditions/illnesses and their teams': 0.195794,
    'Empathy/communication skills training': 0.163854,
    'Dedicated manager resource hub': 0.080184,
    'Clear escalation protocol for manager response': 0.070664,
    'Manager evaluations include how well they support impacted employees': 0.063243,
    'Privacy protection and confidentiality management': 0.058364,
    'AI-powered guidance tools': 0.057976,
    'Legal compliance training': 0.055458,
    'Senior leader coaching on supporting impacted employees': 0.05444,
  },
  4: {
    'Physical rehabilitation support': 0.200125,
    'Nutrition coaching': 0.131656,
    'Insurance advocacy/appeals support': 0.102413,
    'Dedicated navigation support to help employees understand benefits and access medical care': 0.086665,
    'Online tools, apps, or portals for health/benefits support': 0.081798,
    'Occupational therapy/vocational rehabilitation': 0.080645,
    'Care coordination concierge': 0.080454,
    'Survivorship planning assistance': 0.080114,
    'Benefits optimization assistance (maximizing coverage, minimizing costs)': 0.078971,
    'Clinical trial matching service': 0.077159,
  },
  5: {
    'Flexible scheduling options': 0.200035,
    'Ergonomic equipment funding': 0.139896,
    'Temporary role redesigns': 0.112509,
    'Rest areas / quiet spaces': 0.112477,
    'Assistive technology catalog': 0.089373,
    'Cognitive / fatigue support tools': 0.067977,
    'Priority parking': 0.065539,
    'Policy accommodations (e.g., dress code flexibility, headphone use)': 0.05774,
    'Remote work capability': 0.053923,
    'Physical workspace modifications': 0.052283,
    'Transportation reimbursement': 0.048248,
  },
  6: {
    'Employee peer support groups (internal employees with shared experience)': 0.200031,
    'Stigma-reduction initiatives': 0.162809,
    'Anonymous benefits navigation tool or website (no login required)': 0.103945,
    'Specialized emotional counseling': 0.074586,
    'Manager training on handling sensitive health information': 0.066401,
    'Strong anti-discrimination policies specific to health conditions': 0.063477,
    'Inclusive communication guidelines': 0.062323,
    'Professional-led support groups (external facilitator/counselor)': 0.059115,
    'Written anti-retaliation policies for health disclosures': 0.056448,
    'Confidential HR channel for health benefits, policies and insurance-related questions': 0.050846,
    'Clear process for confidential health disclosures': 0.050421,
    'Optional open health dialogue forums': 0.049599,
  },
  7: {
    'Peer mentorship program (employees who had similar condition mentoring current employees)': 0.200073,
    'Continued access to training/development': 0.179655,
    'Adjusted performance goals/deliverables during treatment and recovery': 0.100582,
    'Succession planning protections': 0.097295,
    'Optional stay-connected program': 0.096012,
    'Structured reintegration programs': 0.093588,
    'Career coaching for employees managing cancer or other serious health conditions': 0.082887,
    'Professional coach/mentor for employees managing cancer or other serious health conditions': 0.076365,
    'Project continuity protocols': 0.073542,
  },
  8: {
    'Flexibility for medical setbacks': 0.192209,
    'Long-term success tracking': 0.142762,
    'Manager training on supporting team members during treatment/return': 0.13715,
  ...
  9: {
    'Executive sponsors communicate regularly about workplace support programs': 0.200065,
    'ESG/CSR reporting inclusion': 0.143032,
    'Public success story celebrations': 0.132297,
    'Year-over-year budget growth': 0.087296,
    'Executive-led town halls focused on health benefits and employee support': 0.076675,
    'Support programs included in investor/stakeholder communications': 0.061193,
    'Compensation tied to support outcomes': 0.054609,
    'Executive accountability metrics': 0.050253,
    'C-suite executive serves as program champion/sponsor': 0.049465,
    'Cross-functional executive steering committee for workplace support programs': 0.048861,
    'Support metrics included in annual report/sustainability reporting': 0.048602,
    'Dedicated budget allocation for serious illness support programs': 0.047651,
  },
  10: {
    'Practical support for managing caregiving and work': 0.125861,
    'Eldercare consultation and referral services': 0.098757,
    'Family navigation support': 0.074286,
    'Caregiver resource navigator/concierge': 0.048522,
    'Expanded caregiver leave eligibility beyond legal definitions (e.g., siblings, in-laws, chosen family)': 0.046535,
    'Paid caregiver leave with expanded eligibility (beyond local legal requirements)': 0.046529,
    'Unpaid leave job protection beyond local / legal requirements': 0.043064,
    'Concierge services to coordinate caregiving logistics (e.g., scheduling, transportation, home care)': 0.042984,
    'Flexible work arrangements for caregivers': 0.0416,
    'Emergency dependent care when regular arrangements unavailable': 0.041356,
    'Respite care funding/reimbursement': 0.041004,
    'Paid time off for care coordination appointments': 0.040964,
    'Legal/financial planning assistance for caregivers': 0.040789,
    'Manager training for supervising caregivers': 0.039568,
    'Caregiver peer support groups': 0.039551,
    'Dependent care subsidies': 0.038963,
    'Mental health support specifically for caregivers': 0.038949,
    'Modified job duties during peak caregiving periods': 0.037552,
    'Emergency caregiver funds': 0.036692,
    'Dependent care account matching/contributions': 0.036474,
  },
  11: {
    'Legal protections beyond requirements': 0.165547,
    'Individual health assessments (online or in-person)': 0.145301,
    'Policies to support immuno-compromised colleagues (e.g., mask protocols, ventilation)': 0.12521,
  ...
  12: {
    'Regular program enhancements': 0.200028,
    'Employee confidence in employer support': 0.152164,
    'Innovation pilots': 0.141923,
    'External benchmarking': 0.128859,
    'Program utilization analytics': 0.098957,
    'Return-to-work success metrics': 0.079713,
    'Employee satisfaction tracking': 0.068297,
    'Business impact/ROI assessment': 0.065119,
    'Measure screening campaign ROI (e.g. participation rates, inquiries about access, etc.)': 0.06494,
  },
  13: {
    'Family/caregiver communication inclusion': 0.200081,
    'Employee testimonials/success stories': 0.136827,
    'Proactive communication at point of diagnosis disclosure': 0.131536,
    'Multi-channel communication strategy': 0.098369,
    'Anonymous information access options': 0.098095,
    'Ability to access program information and resources anonymously': 0.094749,
    'Dedicated program website or portal': 0.053243,
    'Regular company-wide awareness campaigns (at least quarterly)': 0.047333,
    'New hire orientation coverage': 0.047072,
    'Manager toolkit for cascade communications': 0.046482,
    'Cancer awareness month campaigns with resources': 0.046213,
  },
};
...
const DIMENSIONS: Record<number, DimensionData> = {
  1: {
    ...
    items: [
      { rank: 1, name: "Emergency leave within 24 hours", weight: 0.143114, equal: 0.076923, delta: 0.066191, stability: 0.92 },
      { rank: 2, name: "Remote work options for on-site employees", weight: 0.128729, equal: 0.076923, delta: 0.051806, stability: 0.925 },
      { rank: 3, name: "Intermittent leave beyond local / legal requirements", weight: 0.113574, equal: 0.076923, delta: 0.036651, stability: 0.835 },
      { rank: 4, name: "Paid micro-breaks for side effects", weight: 0.081779, equal: 0.076923, delta: 0.004856, stability: 0.76 },
      { rank: 5, name: "Flexible work hours during treatment (e.g., varying start/end times...", weight: 0.075997, equal: 0.076923, delta: -0.000926, stability: 0.715 },
      { rank: 6, name: "Job protection beyond local / legal requirements", weight: 0.062303, equal: 0.076923, delta: -0.01462, stability: 0.48 },
      { rank: 7, name: "Paid medical leave beyond local / legal requirements", weight: 0.058979, equal: 0.076923, delta: -0.017944, stability: 0.395 },
      { rank: 8, name: "Reduced schedule/part-time with full benefits", weight: 0.057912, equal: 0.076923, delta: -0.019011, stability: 0.425 },
      { rank: 9, name: "Paid micro-breaks for medical-related side effects", weight: 0.056012, equal: 0.076923, delta: -0.020911, stability: 0.36 },
      { rank: 10, name: "PTO accrual during leave", weight: 0.05581, equal: 0.076923, delta: -0.021113, stability: 0.335 },
      { rank: 11, name: "Full salary (100%) continuation during cancer-related short-term di...", weight: 0.055342, equal: 0.076923, delta: -0.021581, stability: 0.295 },
      { rank: 12, name: "Disability pay top-up (employer adds to disability insurance)", weight: 0.055325, equal: 0.076923, delta: -0.021598, stability: 0.285 },
      { rank: 13, name: "Leave donation bank (employees can donate PTO to colleagues)", weight: 0.055124, equal: 0.076923, delta: -0.021799, stability: 0.27 },
    ]
  },
  2: {
    ...
    items: [
      { rank: 1, name: "Accelerated life insurance benefits (partial payout for terminal / ...", weight: 0.172389, equal: 0.058824, delta: 0.113566, stability: 0.96 },
      { rank: 2, name: "Tax/estate planning assistance", weight: 0.134633, equal: 0.058824, delta: 0.075809, stability: 0.91 },
      { rank: 3, name: "Real-time cost estimator tools", weight: 0.074168, equal: 0.058824, delta: 0.015344, stability: 0.825 },
      { rank: 4, name: "Insurance advocacy/pre-authorization support", weight: 0.071963, equal: 0.058824, delta: 0.01314, stability: 0.78 },
      { rank: 5, name: "$0 copay for specialty drugs", weight: 0.055324, equal: 0.058824, delta: -0.003499, stability: 0.62 },
      { rank: 6, name: "Coverage for advanced therapies (CAR-T, proton therapy, immunothera...", weight: 0.046307, equal: 0.058824, delta: -0.012517, stability: 0.515 },
      { rank: 7, name: "Financial counseling services", weight: 0.044892, equal: 0.058824, delta: -0.013932, stability: 0.485 },
      { rank: 8, name: "Long-term disability covering 60%+ of salary", weight: 0.044791, equal: 0.058824, delta: -0.014032, stability: 0.525 },
      { rank: 9, name: "Paid time off for clinical trial participation", weight: 0.04334, equal: 0.058824, delta: -0.015484, stability: 0.505 },
      { rank: 10, name: "Coverage for clinical trials and experimental treatments not covere...", weight: 0.042387, equal: 0.058824, delta: -0.016437, stability: 0.485 },
      { rank: 11, name: "Short-term disability covering 60%+ of salary", weight: 0.042358, equal: 0.058824, delta: -0.016466, stability: 0.45 },
      { rank: 12, name: "Hardship grants program funded by employer", weight: 0.039505, equal: 0.058824, delta: -0.019319, stability: 0.395 },
      { rank: 13, name: "Guaranteed job protection", weight: 0.038521, equal: 0.058824, delta: -0.020302, stability: 0.36 },
      { rank: 14, name: "Employer-paid disability insurance supplements", weight: 0.037982, equal: 0.058824, delta: -0.020842, stability: 0.325 },
      { rank: 15, name: "Voluntary supplemental illness insurance (with employer contribution)", weight: 0.037766, equal: 0.058824, delta: -0.021058, stability: 0.34 },
      { rank: 16, name: "Set out-of-pocket maximums (for in-network single coverage)", weight: 0.036936, equal: 0.058824, delta: -0.021887, stability: 0.26 },
      { rank: 17, name: "Travel/lodging reimbursement for specialized care beyond insurance ...", weight: 0.036738, equal: 0.058824, delta: -0.022085, stability: 0.26 },
    ]
  },
  3: {
    ...
    items: [
      { rank: 1, name: "Manager peer support / community building", weight: 0.200023, equal: 0.1, delta: 0.100023, stability: 0.9 },
      { rank: 2, name: "Manager training on supporting employees managing cancer or other s...", weight: 0.195794, equal: 0.1, delta: 0.095794, stability: 0.865 },
      { rank: 3, name: "Empathy/communication skills training", weight: 0.163854, equal: 0.1, delta: 0.063854, stability: 0.775 },
      { rank: 4, name: "Dedicated manager resource hub", weight: 0.080184, equal: 0.1, delta: -0.019816, stability: 0.505 },
      { rank: 5, name: "Clear escalation protocol for manager response", weight: 0.070664, equal: 0.1, delta: -0.029336, stability: 0.46 },
      { rank: 6, name: "Manager evaluations include how well they support impacted employees", weight: 0.063243, equal: 0.1, delta: -0.036757, stability: 0.37 },
      { rank: 7, name: "Privacy protection and confidentiality management", weight: 0.058364, equal: 0.1, delta: -0.041636, stability: 0.325 },
      { rank: 8, name: "AI-powered guidance tools", weight: 0.057976, equal: 0.1, delta: -0.042024, stability: 0.33 },
      { rank: 9, name: "Legal compliance training", weight: 0.055458, equal: 0.1, delta: -0.044542, stability: 0.235 },
      { rank: 10, name: "Senior leader coaching on supporting impacted employees", weight: 0.05444, equal: 0.1, delta: -0.04556, stability: 0.235 },
    ]
  },
  4: {
    ...
    items: [
      { rank: 1, name: "Physical rehabilitation support", weight: 0.200125, equal: 0.1, delta: 0.100125, stability: 0.98 },
      { rank: 2, name: "Nutrition coaching", weight: 0.131656, equal: 0.1, delta: 0.031656, stability: 0.73 },
      { rank: 3, name: "Insurance advocacy/appeals support", weight: 0.102413, equal: 0.1, delta: 0.002413, stability: 0.625 },
      { rank: 4, name: "Dedicated navigation support to help employees understand benefits ...", weight: 0.086665, equal: 0.1, delta: -0.013335, stability: 0.475 },
      { rank: 5, name: "Online tools, apps, or portals for health/benefits support", weight: 0.081798, equal: 0.1, delta: -0.018202, stability: 0.42 },
      { rank: 6, name: "Occupational therapy/vocational rehabilitation", weight: 0.080645, equal: 0.1, delta: -0.019355, stability: 0.37 },
      { rank: 7, name: "Care coordination concierge", weight: 0.080454, equal: 0.1, delta: -0.019546, stability: 0.38 },
      { rank: 8, name: "Survivorship planning assistance", weight: 0.080114, equal: 0.1, delta: -0.019886, stability: 0.385 },
      { rank: 9, name: "Benefits optimization assistance (maximizing coverage, minimizing c...", weight: 0.078971, equal: 0.1, delta: -0.021029, stability: 0.35 },
      { rank: 10, name: "Clinical trial matching service", weight: 0.077159, equal: 0.1, delta: -0.022841, stability: 0.285 },
    ]
  },
  5: {
    ...
    items: [
      { rank: 1, name: "Flexible scheduling options", weight: 0.200035, equal: 0.090909, delta: 0.109126, stability: 0.84 },
      { rank: 2, name: "Ergonomic equipment funding", weight: 0.139896, equal: 0.090909, delta: 0.048987, stability: 0.79 },
      { rank: 3, name: "Temporary role redesigns", weight: 0.112509, equal: 0.090909, delta: 0.0216, stability: 0.71 },
      { rank: 4, name: "Rest areas / quiet spaces", weight: 0.112477, equal: 0.090909, delta: 0.021568, stability: 0.72 },
      { rank: 5, name: "Assistive technology catalog", weight: 0.089373, equal: 0.090909, delta: -0.001536, stability: 0.63 },
      { rank: 6, name: "Cognitive / fatigue support tools", weight: 0.067977, equal: 0.090909, delta: -0.022933, stability: 0.49 },
      { rank: 7, name: "Priority parking", weight: 0.065539, equal: 0.090909, delta: -0.02537, stability: 0.52 },
      { rank: 8, name: "Policy accommodations (e.g., dress code flexibility, headphone use)", weight: 0.05774, equal: 0.090909, delta: -0.033169, stability: 0.44 },
      { rank: 9, name: "Remote work capability", weight: 0.053923, equal: 0.090909, delta: -0.036986, stability: 0.325 },
      { rank: 10, name: "Physical workspace modifications", weight: 0.052283, equal: 0.090909, delta: -0.038626, stability: 0.3 },
      { rank: 11, name: "Transportation reimbursement", weight: 0.048248, equal: 0.090909, delta: -0.042661, stability: 0.235 },
    ]
  },
  6: {
    name: "Culture & Stigma",
    ...
    items: [
      { rank: 1, name: "Employee peer support groups (internal employees with shared experi...", weight: 0.200031, equal: 0.083333, delta: 0.116697, stability: 0.985 },
      { rank: 2, name: "Stigma-reduction initiatives", weight: 0.162809, equal: 0.083333, delta: 0.079476, stability: 0.77 },
      { rank: 3, name: "Anonymous benefits navigation tool or website (no login required)", weight: 0.103945, equal: 0.083333, delta: 0.020611, stability: 0.745 },
      { rank: 4, name: "Specialized emotional counseling", weight: 0.074586, equal: 0.083333, delta: -0.008747, stability: 0.505 },
      { rank: 5, name: "Manager training on handling sensitive health information", weight: 0.066401, equal: 0.083333, delta: -0.016933, stability: 0.47 },
      { rank: 6, name: "Strong anti-discrimination policies specific to health conditions", weight: 0.063477, equal: 0.083333, delta: -0.019856, stability: 0.47 },
      { rank: 7, name: "Inclusive communication guidelines", weight: 0.062323, equal: 0.083333, delta: -0.021011, stability: 0.435 },
      { rank: 8, name: "Professional-led support groups (external facilitator/counselor)", weight: 0.059115, equal: 0.083333, delta: -0.024218, stability: 0.45 },
      { rank: 9, name: "Written anti-retaliation policies for health disclosures", weight: 0.056448, equal: 0.083333, delta: -0.026886, stability: 0.37 },
      { rank: 10, name: "Confidential HR channel for health benefits, policies and insurance...", weight: 0.050846, equal: 0.083333, delta: -0.032487, stability: 0.305 },
      { rank: 11, name: "Clear process for confidential health disclosures", weight: 0.050421, equal: 0.083333, delta: -0.032912, stability: 0.245 },
      { rank: 12, name: "Optional open health dialogue forums", weight: 0.049599, equal: 0.083333, delta: -0.033734, stability: 0.25 },
    ]
  },
  7: {
    ...
    items: [
      { rank: 1, name: "Peer mentorship program (employees who had similar condition mentor...", weight: 0.200073, equal: 0.111111, delta: 0.088962, stability: 0.985 },
      { rank: 2, name: "Continued access to training/development", weight: 0.179655, equal: 0.111111, delta: 0.068544, stability: 0.87 },
      { rank: 3, name: "Adjusted performance goals/deliverables during treatment and recovery", weight: 0.100582, equal: 0.111111, delta: -0.010529, stability: 0.59 },
      { rank: 4, name: "Succession planning protections", weight: 0.097295, equal: 0.111111, delta: -0.013816, stability: 0.56 },
      { rank: 5, name: "Optional stay-connected program", weight: 0.096012, equal: 0.111111, delta: -0.015099, stability: 0.52 },
      { rank: 6, name: "Structured reintegration programs", weight: 0.093588, equal: 0.111111, delta: -0.017523, stability: 0.51 },
      { rank: 7, name: "Career coaching for employees managing cancer or other serious heal...", weight: 0.082887, equal: 0.111111, delta: -0.028224, stability: 0.43 },
      { rank: 8, name: "Professional coach/mentor for employees managing cancer or other se...", weight: 0.076365, equal: 0.111111, delta: -0.034746, stability: 0.325 },
      { rank: 9, name: "Project continuity protocols", weight: 0.073542, equal: 0.111111, delta: -0.037569, stability: 0.21 },
    ]
  },
  8: {
    ...
    items: [
      { rank: 1, name: "Flexibility for medical setbacks", weight: 0.192209, equal: 0.083333, delta: 0.108876, stability: 0.83 },
      { rank: 2, name: "Long-term success tracking", weight: 0.142762, equal: 0.083333, delta: 0.059428, stability: 0.88 },
      { rank: 3, name: "Manager training on supporting team members during treatment/return", weight: 0.13715, equal: 0.083333, delta: 0.053816, stability: 0.815 },
      { rank: 4, name: "Workload adjustments during treatment", weight: 0.091974, equal: 0.083333, delta: 0.008641, stability: 0.635 },
      { rank: 5, name: "Access to occupational therapy/vocational rehabilitation", weight: 0.079713, equal: 0.083333, delta: -0.00362, stability: 0.63 },
      { rank: 6, name: "Buddy/mentor pairing for support", weight: 0.058763, equal: 0.083333, delta: -0.02457, stability: 0.475 },
      { rank: 7, name: "Structured progress reviews", weight: 0.057281, equal: 0.083333, delta: -0.026052, stability: 0.385 },
      { rank: 8, name: "Flexible work arrangements during treatment", weight: 0.054804, equal: 0.083333, delta: -0.028529, stability: 0.395 },
      { rank: 9, name: "Online peer support forums", weight: 0.053836, equal: 0.083333, delta: -0.029497, stability: 0.415 },
      { rank: 10, name: "Phased return-to-work plans", weight: 0.044535, equal: 0.083333, delta: -0.038798, stability: 0.195 },
      { rank: 11, name: "Contingency planning for treatment schedules", weight: 0.044362, equal: 0.083333, delta: -0.038971, stability: 0.21 },
      { rank: 12, name: "Access to specialized work resumption professionals", weight: 0.042611, equal: 0.083333, delta: -0.040723, stability: 0.135 },
    ]
  },
  9: {
    ...
    items: [
      { rank: 1, name: "Executive sponsors communicate regularly about workplace support pr...", weight: 0.200065, equal: 0.083333, delta: 0.116732, stability: 0.97 },
      { rank: 2, name: "ESG/CSR reporting inclusion", weight: 0.143032, equal: 0.083333, delta: 0.059699, stability: 0.72 },
      { rank: 3, name: "Public success story celebrations", weight: 0.132297, equal: 0.083333, delta: 0.048964, stability: 0.76 },
      { rank: 4, name: "Year-over-year budget growth", weight: 0.087296, equal: 0.083333, delta: 0.003963, stability: 0.645 },
      { rank: 5, name: "Executive-led town halls focused on health benefits and employee su...", weight: 0.076675, equal: 0.083333, delta: -0.006659, stability: 0.59 },
      { rank: 6, name: "Support programs included in investor/stakeholder communications", weight: 0.061193, equal: 0.083333, delta: -0.022141, stability: 0.435 },
      { rank: 7, name: "Compensation tied to support outcomes", weight: 0.054609, equal: 0.083333, delta: -0.028724, stability: 0.43 },
      { rank: 8, name: "Executive accountability metrics", weight: 0.050253, equal: 0.083333, delta: -0.033081, stability: 0.315 },
      { rank: 9, name: "C-suite executive serves as program champion/sponsor", weight: 0.049465, equal: 0.083333, delta: -0.033868, stability: 0.3 },
      { rank: 10, name: "Cross-functional executive steering committee for workplace support...", weight: 0.048861, equal: 0.083333, delta: -0.034472, stability: 0.295 },
      { rank: 11, name: "Support metrics included in annual report/sustainability reporting", weight: 0.048602, equal: 0.083333, delta: -0.034731, stability: 0.275 },
      { rank: 12, name: "Dedicated budget allocation for serious illness support programs", weight: 0.047651, equal: 0.083333, delta: -0.035682, stability: 0.265 },
    ]
  },
  10: {
    ...
    items: [
      { rank: 1, name: "Practical support for managing caregiving and work", weight: 0.125861, equal: 0.05, delta: 0.075861, stability: 0.92 },
      { rank: 2, name: "Eldercare consultation and referral services", weight: 0.098757, equal: 0.05, delta: 0.048757, stability: 0.81 },
      { rank: 3, name: "Family navigation support", weight: 0.074286, equal: 0.05, delta: 0.024286, stability: 0.775 },
      { rank: 4, name: "Caregiver resource navigator/concierge", weight: 0.048522, equal: 0.05, delta: -0.001478, stability: 0.565 },
      { rank: 5, name: "Expanded caregiver leave eligibility beyond legal definitions (e.g....", weight: 0.046535, equal: 0.05, delta: -0.003465, stability: 0.56 },
      { rank: 6, name: "Paid caregiver leave with expanded eligibility (beyond local legal ...", weight: 0.046529, equal: 0.05, delta: -0.003471, stability: 0.545 },
      { rank: 7, name: "Unpaid leave job protection beyond local / legal requirements", weight: 0.043064, equal: 0.05, delta: -0.006936, stability: 0.48 },
      { rank: 8, name: "Concierge services to coordinate caregiving logistics (e.g., schedu...", weight: 0.042984, equal: 0.05, delta: -0.007016, stability: 0.505 },
      { rank: 9, name: "Flexible work arrangements for caregivers", weight: 0.0416, equal: 0.05, delta: -0.0084, stability: 0.455 },
      { rank: 10, name: "Emergency dependent care when regular arrangements unavailable", weight: 0.041356, equal: 0.05, delta: -0.008644, stability: 0.48 },
      { rank: 11, name: "Respite care funding/reimbursement", weight: 0.041004, equal: 0.05, delta: -0.008996, stability: 0.465 },
      { rank: 12, name: "Paid time off for care coordination appointments", weight: 0.040964, equal: 0.05, delta: -0.009036, stability: 0.44 },
      { rank: 13, name: "Legal/financial planning assistance for caregivers", weight: 0.040789, equal: 0.05, delta: -0.009211, stability: 0.455 },
      { rank: 14, name: "Manager training for supervising caregivers", weight: 0.039568, equal: 0.05, delta: -0.010432, stability: 0.44 },
      { rank: 15, name: "Caregiver peer support groups", weight: 0.039551, equal: 0.05, delta: -0.010449, stability: 0.42 },
      { rank: 16, name: "Dependent care subsidies", weight: 0.038963, equal: 0.05, delta: -0.011037, stability: 0.42 },
      { rank: 17, name: "Mental health support specifically for caregivers", weight: 0.038949, equal: 0.05, delta: -0.011051, stability: 0.4 },
      { rank: 18, name: "Modified job duties during peak caregiving periods", weight: 0.037552, equal: 0.05, delta: -0.012448, stability: 0.32 },
      { rank: 19, name: "Emergency caregiver funds", weight: 0.036692, equal: 0.05, delta: -0.013308, stability: 0.285 },
      { rank: 20, name: "Dependent care account matching/contributions", weight: 0.036474, equal: 0.05, delta: -0.013526, stability: 0.26 },
    ]
  },
  11: {
    ...
    items: [
      { rank: 1, name: "Legal protections beyond requirements", weight: 0.165547, equal: 0.076923, delta: 0.088624, stability: 0.96 },
      { rank: 2, name: "Individual health assessments (online or in-person)", weight: 0.145301, equal: 0.076923, delta: 0.068378, stability: 0.855 },
      { rank: 3, name: "Policies to support immuno-compromised colleagues (e.g., mask proto...", weight: 0.12521, equal: 0.076923, delta: 0.048287, stability: 0.81 },
      { rank: 4, name: "Genetic screening/counseling", weight: 0.117179, equal: 0.076923, delta: 0.040256, stability: 0.83 },
      { rank: 5, name: "Full or partial coverage for annual health screenings/checkups", weight: 0.059233, equal: 0.076923, delta: -0.01769, stability: 0.51 },
      { rank: 6, name: "Regular health education sessions", weight: 0.054959, equal: 0.076923, delta: -0.021964, stability: 0.465 },
      { rank: 7, name: "Paid time off for preventive care appointments", weight: 0.054171, equal: 0.076923, delta: -0.022752, stability: 0.515 },
      { rank: 8, name: "At least 70% coverage for regionally / locally recommended screenings", weight: 0.053351, equal: 0.076923, delta: -0.023572, stability: 0.435 },
      { rank: 9, name: "On-site vaccinations", weight: 0.049866, equal: 0.076923, delta: -0.027057, stability: 0.4 },
      { rank: 10, name: "Workplace safety assessments to minimize health risks", weight: 0.045736, equal: 0.076923, delta: -0.031187, stability: 0.39 },
      { rank: 11, name: "Targeted risk-reduction programs", weight: 0.045514, equal: 0.076923, delta: -0.031409, stability: 0.355 },
      { rank: 12, name: "Risk factor tracking/reporting", weight: 0.044358, equal: 0.076923, delta: -0.032565, stability: 0.315 },
      { rank: 13, name: "Lifestyle coaching programs", weight: 0.039574, equal: 0.076923, delta: -0.03735, stability: 0.16 },
    ]
  },
  12: {
    ...
    items: [
      { rank: 1, name: "Regular program enhancements", weight: 0.200028, equal: 0.111111, delta: 0.088917, stability: 0.9 },
      { rank: 2, name: "Employee confidence in employer support", weight: 0.152164, equal: 0.111111, delta: 0.041052, stability: 0.735 },
      { rank: 3, name: "Innovation pilots", weight: 0.141923, equal: 0.111111, delta: 0.030812, stability: 0.765 },
      { rank: 4, name: "External benchmarking", weight: 0.128859, equal: 0.111111, delta: 0.017748, stability: 0.745 },
      { rank: 5, name: "Program utilization analytics", weight: 0.098957, equal: 0.111111, delta: -0.012155, stability: 0.55 },
      { rank: 6, name: "Return-to-work success metrics", weight: 0.079713, equal: 0.111111, delta: -0.031398, stability: 0.465 },
      { rank: 7, name: "Employee satisfaction tracking", weight: 0.068297, equal: 0.111111, delta: -0.042814, stability: 0.35 },
      { rank: 8, name: "Business impact/ROI assessment", weight: 0.065119, equal: 0.111111, delta: -0.045992, stability: 0.25 },
      { rank: 9, name: "Measure screening campaign ROI (e.g. participation rates, inquiries...", weight: 0.06494, equal: 0.111111, delta: -0.046171, stability: 0.24 },
    ]
  },
  13: {
    ...
    topElements: [
      ...
      "Proactive communication at point of diagnosis disc",
    ],
    items: [
      { rank: 1, name: "Family/caregiver communication inclusion", weight: 0.200081, equal: 0.090909, delta: 0.109172, stability: 0.97 },
      { rank: 2, name: "Employee testimonials/success stories", weight: 0.136827, equal: 0.090909, delta: 0.045918, stability: 0.855 },
      { rank: 3, name: "Proactive communication at point of diagnosis disclosure", weight: 0.131536, equal: 0.090909, delta: 0.040627, stability: 0.915 },
      { rank: 4, name: "Multi-channel communication strategy", weight: 0.098369, equal: 0.090909, delta: 0.00746, stability: 0.685 },
      { rank: 5, name: "Anonymous information access options", weight: 0.098095, equal: 0.090909, delta: 0.007186, stability: 0.84 },
      { rank: 6, name: "Ability to access program information and resources anonymously", weight: 0.094749, equal: 0.090909, delta: 0.00384, stability: 0.805 },
      { rank: 7, name: "Dedicated program website or portal", weight: 0.053243, equal: 0.090909, delta: -0.037666, stability: 0.38 },
      { rank: 8, name: "Regular company-wide awareness campaigns (at least quarterly)", weight: 0.047333, equal: 0.090909, delta: -0.043576, stability: 0.185 },
      { rank: 9, name: "New hire orientation coverage", weight: 0.047072, equal: 0.090909, delta: -0.043838, stability: 0.17 },
      { rank: 10, name: "Manager toolkit for cascade communications", weight: 0.046482, equal: 0.090909, delta: -0.044427, stability: 0.115 },
      { rank: 11, name: "Cancer awareness month campaigns with resources", weight: 0.046213, equal: 0.090909, delta: -0.044696, stability: 0.08 },
    ]
  },
};
