...
// Ordinal Ridge + Permutation Importance + Adaptive α
// D1 & D13: Duplicate elements merged (higher + 50% of lower), renormalized, 20% cap applied
// ============================================

const ELEMENT_WEIGHTS: Record<number, Record<string, number>> = {
  1: {
    // 13 raw elements → 12 after merging "Paid micro-breaks for side effects" + "Paid micro-breaks for medical-related side effects"
    'Emergency leave within 24 hours': 0.147238,
    'Remote work options for on-site employees': 0.132438,
    'Intermittent leave beyond local / legal requirements': 0.116846,
    'Paid micro-breaks for medical-related side effects': 0.112948, // merged: 0.081779 + 50% × 0.056012, renormalized
    'Flexible work hours during treatment (e.g., varying start/end times, compressed schedules)': 0.078187,
    'Job protection beyond local / legal requirements': 0.064098,
    'Paid medical leave beyond local / legal requirements': 0.060678,
    'Reduced schedule/part-time with full benefits': 0.059581,
    'PTO accrual during leave': 0.057418,
    'Full salary (100%) continuation during cancer-related short-term disability leave': 0.056937,
    'Disability pay top-up (employer adds to disability insurance)': 0.056919,
    'Leave donation bank (employees can donate PTO to colleagues)': 0.056712,
  },
  2: {
  ...
  3: {
    ...
    'Senior leader coaching on supporting impacted employees': 0.054440,
  },
  4: {
  ...
  5: {
    ...
    'Policy accommodations (e.g., dress code flexibility, headphone use)': 0.057740,
  ...
  9: {
    // 12 elements in v6.1 (added "Executive-led town halls...")
  ...
  10: {
    // 20 elements in v6.1 (added "Concierge services..." — still excluded from scoring by D10_EXCLUDED_ITEMS)
    ...
    'Flexible work arrangements for caregivers': 0.041600,
  ...
  12: {
    // 9 elements in v6.1 (added "Measure screening campaign ROI...")
    ...
    'Measure screening campaign ROI (e.g. participation rates, inquiries about access, etc.)': 0.064940,
  },
  13: {
    // 11 raw elements → 10 after merging "Anonymous information access options" + "Ability to access program information and resources anonymously"
    'Family/caregiver communication inclusion': 0.200000, // capped at 20%
    'Ability to access program information and resources anonymously': 0.154643, // merged: 0.098095 + 50% × 0.094749, renormalized
    'Employee testimonials/success stories': 0.145455,
    'Proactive communication at point of diagnosis disclosure': 0.139830,
    'Multi-channel communication strategy': 0.104572,
    'Dedicated program website or portal': 0.056601,
    'Regular company-wide awareness campaigns (at least quarterly)': 0.050318,
    'New hire orientation coverage': 0.050040,
    'Manager toolkit for cascade communications': 0.049414,
    'Cancer awareness month campaigns with resources': 0.049127,
  },
};
...
const DIMENSIONS: Record<number, DimensionData> = {
  1: {
    ...
    items: [
      { rank: 1, name: "Emergency leave within 24 hours", weight: 0.147238, equal: 0.083333, delta: 0.063905 },
      { rank: 2, name: "Remote work options for on-site employees", weight: 0.132438, equal: 0.083333, delta: 0.049105 },
      { rank: 3, name: "Intermittent leave beyond local / legal requirements", weight: 0.116846, equal: 0.083333, delta: 0.033513 },
      { rank: 4, name: "Paid micro-breaks for medical-related side effects (merged)", weight: 0.112948, equal: 0.083333, delta: 0.029615 },
      { rank: 5, name: "Flexible work hours during treatment (e.g., varying start/end times...", weight: 0.078187, equal: 0.083333, delta: -0.005146 },
      { rank: 6, name: "Job protection beyond local / legal requirements", weight: 0.064098, equal: 0.083333, delta: -0.019235 },
      { rank: 7, name: "Paid medical leave beyond local / legal requirements", weight: 0.060678, equal: 0.083333, delta: -0.022655 },
      { rank: 8, name: "Reduced schedule/part-time with full benefits", weight: 0.059581, equal: 0.083333, delta: -0.023752 },
      { rank: 9, name: "PTO accrual during leave", weight: 0.057418, equal: 0.083333, delta: -0.025915 },
      { rank: 10, name: "Full salary (100%) continuation during cancer-related STD leave", weight: 0.056937, equal: 0.083333, delta: -0.026396 },
      { rank: 11, name: "Disability pay top-up (employer adds to disability insurance)", weight: 0.056919, equal: 0.083333, delta: -0.026414 },
      { rank: 12, name: "Leave donation bank (employees can donate PTO to colleagues)", weight: 0.056712, equal: 0.083333, delta: -0.026621 },
    ]
  },
  2: {
  ...
  3: {
    ...
    items: [
      { rank: 1, name: "Manager peer support / community building", weight: 0.200023, equal: 0.1, delta: 0.100023 },
      { rank: 2, name: "Manager training on supporting employees managing cancer or other s...", weight: 0.195794, equal: 0.1, delta: 0.095794 },
      { rank: 3, name: "Empathy/communication skills training", weight: 0.163854, equal: 0.1, delta: 0.063854 },
      { rank: 4, name: "Dedicated manager resource hub", weight: 0.080184, equal: 0.1, delta: -0.019816 },
      { rank: 5, name: "Clear escalation protocol for manager response", weight: 0.070664, equal: 0.1, delta: -0.029336 },
      { rank: 6, name: "Manager evaluations include how well they support impacted employees", weight: 0.063243, equal: 0.1, delta: -0.036757 },
      { rank: 7, name: "Privacy protection and confidentiality management", weight: 0.058364, equal: 0.1, delta: -0.041636 },
      { rank: 8, name: "AI-powered guidance tools", weight: 0.057976, equal: 0.1, delta: -0.042024 },
      { rank: 9, name: "Legal compliance training", weight: 0.055458, equal: 0.1, delta: -0.044542 },
      { rank: 10, name: "Senior leader coaching on supporting impacted employees", weight: 0.054440, equal: 0.1, delta: -0.045560 },
    ]
  },
  4: {
  ...
  9: {
    ...
    items: [
      { rank: 1, name: "Executive sponsors communicate regularly about workplace support pr...", weight: 0.200065, equal: 0.083333, delta: 0.116732 },
      { rank: 2, name: "ESG/CSR reporting inclusion", weight: 0.143032, equal: 0.083333, delta: 0.059699 },
      { rank: 3, name: "Public success story celebrations", weight: 0.132297, equal: 0.083333, delta: 0.048964 },
      { rank: 4, name: "Year-over-year budget growth", weight: 0.087296, equal: 0.083333, delta: 0.003963 },
      { rank: 5, name: "Executive-led town halls focused on health benefits and employee su...", weight: 0.076675, equal: 0.083333, delta: -0.006659 },
      { rank: 6, name: "Support programs included in investor/stakeholder communications", weight: 0.061193, equal: 0.083333, delta: -0.022141 },
      { rank: 7, name: "Compensation tied to support outcomes", weight: 0.054609, equal: 0.083333, delta: -0.028724 },
      { rank: 8, name: "Executive accountability metrics", weight: 0.050253, equal: 0.083333, delta: -0.033081 },
      { rank: 9, name: "C-suite executive serves as program champion/sponsor", weight: 0.049465, equal: 0.083333, delta: -0.033868 },
      { rank: 10, name: "Cross-functional executive steering committee for workplace support...", weight: 0.048861, equal: 0.083333, delta: -0.034472 },
      { rank: 11, name: "Support metrics included in annual report/sustainability reporting", weight: 0.048602, equal: 0.083333, delta: -0.034731 },
      { rank: 12, name: "Dedicated budget allocation for serious illness support programs", weight: 0.047651, equal: 0.083333, delta: -0.035682 },
    ]
  },
  10: {
    ...
    items: [
      { rank: 1, name: "Practical support for managing caregiving and work", weight: 0.125861, equal: 0.050000, delta: 0.075861 },
      { rank: 2, name: "Eldercare consultation and referral services", weight: 0.098757, equal: 0.050000, delta: 0.048757 },
      { rank: 3, name: "Family navigation support", weight: 0.074286, equal: 0.050000, delta: 0.024286 },
      { rank: 4, name: "Caregiver resource navigator/concierge", weight: 0.048522, equal: 0.050000, delta: -0.001478 },
      { rank: 5, name: "Expanded caregiver leave eligibility beyond legal definitions (e.g....", weight: 0.046535, equal: 0.050000, delta: -0.003465 },
      { rank: 6, name: "Paid caregiver leave with expanded eligibility (beyond local legal ...", weight: 0.046529, equal: 0.050000, delta: -0.003471 },
      { rank: 7, name: "Unpaid leave job protection beyond local / legal requirements", weight: 0.043064, equal: 0.050000, delta: -0.006936 },
      { rank: 8, name: "Concierge services to coordinate caregiving logistics (e.g., schedu...", weight: 0.042984, equal: 0.050000, delta: -0.007016 },
      { rank: 9, name: "Flexible work arrangements for caregivers", weight: 0.041600, equal: 0.050000, delta: -0.008400 },
      { rank: 10, name: "Emergency dependent care when regular arrangements unavailable", weight: 0.041356, equal: 0.050000, delta: -0.008644 },
      { rank: 11, name: "Respite care funding/reimbursement", weight: 0.041004, equal: 0.050000, delta: -0.008996 },
      { rank: 12, name: "Paid time off for care coordination appointments", weight: 0.040964, equal: 0.050000, delta: -0.009036 },
      { rank: 13, name: "Legal/financial planning assistance for caregivers", weight: 0.040789, equal: 0.050000, delta: -0.009211 },
      { rank: 14, name: "Manager training for supervising caregivers", weight: 0.039568, equal: 0.050000, delta: -0.010432 },
      { rank: 15, name: "Caregiver peer support groups", weight: 0.039551, equal: 0.050000, delta: -0.010449 },
      { rank: 16, name: "Dependent care subsidies", weight: 0.038963, equal: 0.050000, delta: -0.011037 },
      { rank: 17, name: "Mental health support specifically for caregivers", weight: 0.038949, equal: 0.050000, delta: -0.011051 },
      { rank: 18, name: "Modified job duties during peak caregiving periods", weight: 0.037552, equal: 0.050000, delta: -0.012448 },
      { rank: 19, name: "Emergency caregiver funds", weight: 0.036692, equal: 0.050000, delta: -0.013308 },
      { rank: 20, name: "Dependent care account matching/contributions", weight: 0.036474, equal: 0.050000, delta: -0.013526 },
    ]
  },
  11: {
  ...
  12: {
    ...
    items: [
      { rank: 1, name: "Regular program enhancements", weight: 0.200028, equal: 0.111111, delta: 0.088917 },
      { rank: 2, name: "Employee confidence in employer support", weight: 0.152164, equal: 0.111111, delta: 0.041053 },
      { rank: 3, name: "Innovation pilots", weight: 0.141923, equal: 0.111111, delta: 0.030812 },
      { rank: 4, name: "External benchmarking", weight: 0.128859, equal: 0.111111, delta: 0.017748 },
      { rank: 5, name: "Program utilization analytics", weight: 0.098957, equal: 0.111111, delta: -0.012154 },
      { rank: 6, name: "Return-to-work success metrics", weight: 0.079713, equal: 0.111111, delta: -0.031398 },
      { rank: 7, name: "Employee satisfaction tracking", weight: 0.068297, equal: 0.111111, delta: -0.042814 },
      { rank: 8, name: "Business impact/ROI assessment", weight: 0.065119, equal: 0.111111, delta: -0.045992 },
      { rank: 9, name: "Measure screening campaign ROI (e.g. participation rates, inquiries...", weight: 0.064940, equal: 0.111111, delta: -0.046171 },
    ]
  },
  13: {
    ...
    items: [
      { rank: 1, name: "Family/caregiver communication inclusion", weight: 0.200000, equal: 0.1, delta: 0.1 },
      { rank: 2, name: "Ability to access program information and resources anonymously (me...", weight: 0.154643, equal: 0.1, delta: 0.054643 },
      { rank: 3, name: "Employee testimonials/success stories", weight: 0.145455, equal: 0.1, delta: 0.045455 },
      { rank: 4, name: "Proactive communication at point of diagnosis disclosure", weight: 0.139830, equal: 0.1, delta: 0.039830 },
      { rank: 5, name: "Multi-channel communication strategy", weight: 0.104572, equal: 0.1, delta: 0.004572 },
      { rank: 6, name: "Dedicated program website or portal", weight: 0.056601, equal: 0.1, delta: -0.043399 },
      { rank: 7, name: "Regular company-wide awareness campaigns (at least quarterly)", weight: 0.050318, equal: 0.1, delta: -0.049682 },
      { rank: 8, name: "New hire orientation coverage", weight: 0.050040, equal: 0.1, delta: -0.049960 },
      { rank: 9, name: "Manager toolkit for cascade communications", weight: 0.049414, equal: 0.1, delta: -0.050586 },
      { rank: 10, name: "Cancer awareness month campaigns with resources", weight: 0.049127, equal: 0.1, delta: -0.050873 },
    ]
  },
};
