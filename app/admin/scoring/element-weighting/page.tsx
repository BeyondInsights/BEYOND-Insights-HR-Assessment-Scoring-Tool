...
const ELEMENT_WEIGHTS: Record<number, Record<string, number>> = {
  1: {
    // 13→12 after merge: "Paid micro-breaks for side effects"(0.091662) + "...medical-related..."(0.048096)
    'Emergency leave within 24 hours': 0.164705,
    'Remote work options for on-site employees': 0.125719,
    'Paid micro-breaks for medical-related side effects': 0.118561,
    'Intermittent leave beyond local / legal requirements': 0.108173,
    'Flexible work hours during treatment (e.g., varying start/end times, compressed schedules)': 0.090626,
    'Job protection beyond local / legal requirements': 0.067808,
    'Paid medical leave beyond local / legal requirements': 0.059653,
    'Reduced schedule/part-time with full benefits': 0.058238,
    'Disability pay top-up (employer adds to disability insurance)': 0.053096,
    'Full salary (100%) continuation during cancer-related short-term disability leave': 0.052994,
    'PTO accrual during leave': 0.050816,
    'Leave donation bank (employees can donate PTO to colleagues)': 0.049610,
  },
  2: {
  ...
  13: {
    // 11→10 after merge: "Anonymous information access options"(0.107793) + "Ability to access..."(0.076920)
    'Family/caregiver communication inclusion': 0.183852,
    'Ability to access program information and resources anonymously': 0.152103,
    'Employee testimonials/success stories': 0.125551,
    'Proactive communication at point of diagnosis disclosure': 0.119202,
    'Multi-channel communication strategy': 0.109026,
    'Dedicated program website or portal': 0.075199,
    'New hire orientation coverage': 0.060415,
    'Regular company-wide awareness campaigns (at least quarterly)': 0.059118,
    'Manager toolkit for cascade communications': 0.058892,
    'Cancer awareness month campaigns with resources': 0.056643,
  },
};
...
const DIMENSIONS: Record<number, DimensionData> = {
  1: {
    ...
    items: [
      ...
      { rank: 3, name: "Paid micro-breaks for medical-related side effects (merged)", weight: 0.118561, equal: 0.083333, delta: 0.035228 },
      { rank: 4, name: "Intermittent leave beyond local / legal requirements", weight: 0.108173, equal: 0.083333, delta: 0.024840 },
      { rank: 5, name: "Flexible work hours during treatment (e.g., varying start/end times...", weight: 0.090626, equal: 0.083333, delta: 0.007293 },
      { rank: 6, name: "Job protection beyond local / legal requirements", weight: 0.067808, equal: 0.083333, delta: -0.015525 },
      { rank: 7, name: "Paid medical leave beyond local / legal requirements", weight: 0.059653, equal: 0.083333, delta: -0.023680 },
      { rank: 8, name: "Reduced schedule/part-time with full benefits", weight: 0.058238, equal: 0.083333, delta: -0.025095 },
      { rank: 9, name: "Disability pay top-up (employer adds to disability insurance)", weight: 0.053096, equal: 0.083333, delta: -0.030237 },
      { rank: 10, name: "Full salary (100%) continuation during cancer-related STD leave", weight: 0.052994, equal: 0.083333, delta: -0.030339 },
      { rank: 11, name: "PTO accrual during leave", weight: 0.050816, equal: 0.083333, delta: -0.032517 },
      { rank: 12, name: "Leave donation bank (employees can donate PTO to colleagues)", weight: 0.049610, equal: 0.083333, delta: -0.033723 },
    ]
  },
  2: {
  ...
  13: {
    ...
    items: [
      ...
      { rank: 2, name: "Ability to access program information and resources anonymously (me...", weight: 0.152103, equal: 0.1, delta: 0.052103 },
      { rank: 3, name: "Employee testimonials/success stories", weight: 0.125551, equal: 0.1, delta: 0.025551 },
      { rank: 4, name: "Proactive communication at point of diagnosis disclosure", weight: 0.119202, equal: 0.1, delta: 0.019202 },
      { rank: 5, name: "Multi-channel communication strategy", weight: 0.109026, equal: 0.1, delta: 0.009026 },
      { rank: 6, name: "Dedicated program website or portal", weight: 0.075199, equal: 0.1, delta: -0.024801 },
      { rank: 7, name: "New hire orientation coverage", weight: 0.060415, equal: 0.1, delta: -0.039585 },
      { rank: 8, name: "Regular company-wide awareness campaigns (at least quarterly)", weight: 0.059118, equal: 0.1, delta: -0.040882 },
      { rank: 9, name: "Manager toolkit for cascade communications", weight: 0.058892, equal: 0.1, delta: -0.041108 },
      { rank: 10, name: "Cancer awareness month campaigns with resources", weight: 0.056643, equal: 0.1, delta: -0.043357 },
    ]
  },
};
