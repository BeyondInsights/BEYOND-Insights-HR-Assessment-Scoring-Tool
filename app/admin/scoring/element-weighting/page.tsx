...
const ELEMENT_WEIGHTS: Record<number, Record<string, number>> = {
  1: {
    'Disability pay top-up (employer adds to disability insurance)': 0.2092,
    'Job protection beyond local / legal requirements': 0.2092,
    'Intermittent leave beyond local / legal requirements': 0.1137,
    'Leave donation bank (employees can donate PTO to colleagues)': 0.0913,
    'Emergency leave within 24 hours': 0.0852,
    'Flexible work hours during treatment (e.g., varying start/end times, compressed schedules)': 0.0515,
    'Paid micro-breaks for medical-related side effects': 0.0498,
    'PTO accrual during leave': 0.0475,
    'Paid medical leave beyond local / legal requirements': 0.0475,
    'Reduced schedule/part-time with full benefits': 0.0475,
    'Remote work options for on-site employees': 0.0475,
  },
  2: {
  ...
  9: {
    'Executive sponsors communicate regularly about workplace support programs': 0.216679,
    'ESG/CSR reporting inclusion': 0.15491,
    'Public success story celebrations': 0.143283,
    'Year-over-year budget growth': 0.094545,
    'Support programs included in investor/stakeholder communications': 0.066275,
    'Compensation tied to support outcomes': 0.059144,
    'Executive accountability metrics': 0.054426,
    'C-suite executive serves as program champion/sponsor': 0.053573,
    'Cross-functional executive steering committee for workplace support programs': 0.052919,
    'Support metrics included in annual report/sustainability reporting': 0.052638,
    'Dedicated budget allocation for serious illness support programs': 0.051608,
  },
  10: {
    'Practical support for managing caregiving and work': 0.131514,
    'Eldercare consultation and referral services': 0.103193,
    'Family navigation support': 0.077623,
    'Caregiver resource navigator/concierge': 0.050701,
    'Expanded caregiver leave eligibility beyond legal definitions (e.g., siblings, in-laws, chosen family)': 0.048625,
    'Paid caregiver leave with expanded eligibility (beyond local legal requirements)': 0.048619,
    'Unpaid leave job protection beyond local / legal requirements': 0.044998,
    'Flexible work arrangements for caregivers': 0.043468,
    'Emergency dependent care when regular arrangements unavailable': 0.043213,
    ...
    'Mental health support specifically for caregivers': 0.040698,
    'Modified job duties during peak caregiving periods': 0.039239,
    'Emergency caregiver funds': 0.03834,
  ...
  12: {
    'Regular program enhancements': 0.21392,
    'Employee confidence in employer support': 0.162732,
    'Innovation pilots': 0.15178,
    'External benchmarking': 0.137808,
    'Program utilization analytics': 0.10583,
    'Return-to-work success metrics': 0.085249,
    'Employee satisfaction tracking': 0.07304,
    'Business impact/ROI assessment': 0.069642,
  },
  13: {
    'Dedicated program website or portal': 0.2189,
    'Ability to access program information and resources anonymously': 0.1496,
    'New hire orientation coverage': 0.1188,
    'Manager toolkit for cascade communications': 0.0869,
    'Family/caregiver communication inclusion': 0.0851,
    'Employee testimonials/success stories': 0.0851,
    'Multi-channel communication strategy': 0.0851,
    'Proactive communication at point of diagnosis disclosure': 0.0851,
    'Regular company-wide awareness campaigns (at least quarterly)': 0.0851,
  },
};
...
const DIMENSIONS: Record<number, DimensionData> = {
  1: {
    ...
    n: 36,
    topElements: [
      "Disability pay top-up (employer adds to disabi",
      "Job protection beyond local / legal requiremen",
      "Intermittent leave beyond local / legal require",
    ],
    items: [
      { rank: 1, name: "Disability pay top-up (employer adds to disability insurance)", weight: 0.2092, equal: 0.090909, delta: 0.118291, stability: 0.945 },
      { rank: 2, name: "Job protection beyond local / legal requirements", weight: 0.2092, equal: 0.090909, delta: 0.118291, stability: 0.795 },
      { rank: 3, name: "Intermittent leave beyond local / legal requirements", weight: 0.1137, equal: 0.090909, delta: 0.022791, stability: 0.84 },
      { rank: 4, name: "Leave donation bank (employees can donate PTO to colleagues)", weight: 0.0913, equal: 0.090909, delta: 0.000391, stability: 0.66 },
      { rank: 5, name: "Emergency leave within 24 hours", weight: 0.0852, equal: 0.090909, delta: -0.005709, stability: 0.64 },
      { rank: 6, name: "Flexible work hours during treatment (e.g., varying start/end times...", weight: 0.0515, equal: 0.090909, delta: -0.039409, stability: 0.52 },
      { rank: 7, name: "Paid micro-breaks for medical-related side effects", weight: 0.0498, equal: 0.090909, delta: -0.041109, stability: 0.365 },
      { rank: 8, name: "PTO accrual during leave", weight: 0.0475, equal: 0.090909, delta: -0.043409, stability: 0.055 },
      { rank: 9, name: "Paid medical leave beyond local / legal requirements", weight: 0.0475, equal: 0.090909, delta: -0.043409, stability: 0.0 },
      { rank: 10, name: "Reduced schedule/part-time with full benefits", weight: 0.0475, equal: 0.090909, delta: -0.043409, stability: 0.13 },
      { rank: 11, name: "Remote work options for on-site employees", weight: 0.0475, equal: 0.090909, delta: -0.043409, stability: 0.05 },
    ]
  },
  2: {
  ...
  9: {
    ...
    items: [
      { rank: 1, name: "Executive sponsors communicate regularly about workplace support pr...", weight: 0.216679, equal: 0.090909, delta: 0.12577, stability: 0.97 },
      { rank: 2, name: "ESG/CSR reporting inclusion", weight: 0.15491, equal: 0.090909, delta: 0.064001, stability: 0.72 },
      { rank: 3, name: "Public success story celebrations", weight: 0.143283, equal: 0.090909, delta: 0.052374, stability: 0.76 },
      { rank: 4, name: "Year-over-year budget growth", weight: 0.094545, equal: 0.090909, delta: 0.003636, stability: 0.645 },
      { rank: 5, name: "Support programs included in investor/stakeholder communications", weight: 0.066275, equal: 0.090909, delta: -0.024634, stability: 0.435 },
      { rank: 6, name: "Compensation tied to support outcomes", weight: 0.059144, equal: 0.090909, delta: -0.031765, stability: 0.43 },
      { rank: 7, name: "Executive accountability metrics", weight: 0.054426, equal: 0.090909, delta: -0.036483, stability: 0.315 },
      { rank: 8, name: "C-suite executive serves as program champion/sponsor", weight: 0.053573, equal: 0.090909, delta: -0.037336, stability: 0.3 },
      { rank: 9, name: "Cross-functional executive steering committee for workplace support...", weight: 0.052919, equal: 0.090909, delta: -0.03799, stability: 0.295 },
      { rank: 10, name: "Support metrics included in annual report/sustainability reporting", weight: 0.052638, equal: 0.090909, delta: -0.038271, stability: 0.275 },
      { rank: 11, name: "Dedicated budget allocation for serious illness support programs", weight: 0.051608, equal: 0.090909, delta: -0.039301, stability: 0.265 },
    ]
  },
  10: {
    ...
    items: [
      { rank: 1, name: "Practical support for managing caregiving and work", weight: 0.131514, equal: 0.052632, delta: 0.078882, stability: 0.92 },
      { rank: 2, name: "Eldercare consultation and referral services", weight: 0.103193, equal: 0.052632, delta: 0.050561, stability: 0.81 },
      { rank: 3, name: "Family navigation support", weight: 0.077623, equal: 0.052632, delta: 0.024991, stability: 0.775 },
      { rank: 4, name: "Caregiver resource navigator/concierge", weight: 0.050701, equal: 0.052632, delta: -0.001931, stability: 0.565 },
      { rank: 5, name: "Expanded caregiver leave eligibility beyond legal definitions (e.g....", weight: 0.048625, equal: 0.052632, delta: -0.004007, stability: 0.56 },
      { rank: 6, name: "Paid caregiver leave with expanded eligibility (beyond local legal ...", weight: 0.048619, equal: 0.052632, delta: -0.004013, stability: 0.545 },
      { rank: 7, name: "Unpaid leave job protection beyond local / legal requirements", weight: 0.044998, equal: 0.052632, delta: -0.007634, stability: 0.48 },
      { rank: 8, name: "Flexible work arrangements for caregivers", weight: 0.043468, equal: 0.052632, delta: -0.009164, stability: 0.455 },
      { rank: 9, name: "Emergency dependent care when regular arrangements unavailable", weight: 0.043213, equal: 0.052632, delta: -0.009419, stability: 0.48 },
      { rank: 10, name: "Respite care funding/reimbursement", weight: 0.042846, equal: 0.052632, delta: -0.009786, stability: 0.465 },
      { rank: 11, name: "Paid time off for care coordination appointments", weight: 0.042804, equal: 0.052632, delta: -0.009828, stability: 0.44 },
      { rank: 12, name: "Legal/financial planning assistance for caregivers", weight: 0.042621, equal: 0.052632, delta: -0.010011, stability: 0.455 },
      { rank: 13, name: "Manager training for supervising caregivers", weight: 0.041345, equal: 0.052632, delta: -0.011287, stability: 0.44 },
      { rank: 14, name: "Caregiver peer support groups", weight: 0.041327, equal: 0.052632, delta: -0.011305, stability: 0.42 },
      { rank: 15, name: "Dependent care subsidies", weight: 0.040713, equal: 0.052632, delta: -0.011919, stability: 0.42 },
      { rank: 16, name: "Mental health support specifically for caregivers", weight: 0.040698, equal: 0.052632, delta: -0.011934, stability: 0.4 },
      { rank: 17, name: "Modified job duties during peak caregiving periods", weight: 0.039239, equal: 0.052632, delta: -0.013393, stability: 0.32 },
      { rank: 18, name: "Emergency caregiver funds", weight: 0.03834, equal: 0.052632, delta: -0.014292, stability: 0.285 },
      { rank: 19, name: "Dependent care account matching/contributions", weight: 0.038112, equal: 0.052632, delta: -0.01452, stability: 0.26 },
    ]
  },
  11: {
  ...
  12: {
    ...
    items: [
      { rank: 1, name: "Regular program enhancements", weight: 0.21392, equal: 0.125, delta: 0.08892, stability: 0.9 },
      { rank: 2, name: "Employee confidence in employer support", weight: 0.162732, equal: 0.125, delta: 0.037732, stability: 0.735 },
      { rank: 3, name: "Innovation pilots", weight: 0.15178, equal: 0.125, delta: 0.02678, stability: 0.765 },
      { rank: 4, name: "External benchmarking", weight: 0.137808, equal: 0.125, delta: 0.012808, stability: 0.745 },
      { rank: 5, name: "Program utilization analytics", weight: 0.10583, equal: 0.125, delta: -0.01917, stability: 0.55 },
      { rank: 6, name: "Return-to-work success metrics", weight: 0.085249, equal: 0.125, delta: -0.039751, stability: 0.465 },
      { rank: 7, name: "Employee satisfaction tracking", weight: 0.07304, equal: 0.125, delta: -0.05196, stability: 0.35 },
      { rank: 8, name: "Business impact/ROI assessment", weight: 0.069642, equal: 0.125, delta: -0.055358, stability: 0.25 },
    ]
  },
  13: {
    ...
    topElements: [
      ...
      "Ability to access program information and reso",
      "New hire orientation coverage",
    ],
    items: [
      { rank: 1, name: "Dedicated program website or portal", weight: 0.2189, equal: 0.111111, delta: 0.107789, stability: 0.92 },
      { rank: 2, name: "Ability to access program information and resources anonymously", weight: 0.1496, equal: 0.111111, delta: 0.038489, stability: 0.935 },
      { rank: 3, name: "New hire orientation coverage", weight: 0.1188, equal: 0.111111, delta: 0.007689, stability: 0.495 },
      { rank: 4, name: "Manager toolkit for cascade communications", weight: 0.0869, equal: 0.111111, delta: -0.024211, stability: 0.345 },
      { rank: 5, name: "Family/caregiver communication inclusion", weight: 0.0851, equal: 0.111111, delta: -0.026011, stability: 0.25 },
      { rank: 6, name: "Employee testimonials/success stories", weight: 0.0851, equal: 0.111111, delta: -0.026011, stability: 0.685 },
      { rank: 7, name: "Multi-channel communication strategy", weight: 0.0851, equal: 0.111111, delta: -0.026011, stability: 0.26 },
      { rank: 8, name: "Proactive communication at point of diagnosis disclosure", weight: 0.0851, equal: 0.111111, delta: -0.026011, stability: 0.005 },
      { rank: 9, name: "Regular company-wide awareness campaigns (at least quarterly)", weight: 0.0851, equal: 0.111111, delta: -0.026011, stability: 0.105 },
    ]
  },
};
