 ...
 * 8. NOW USES SHARED CONFIG (lib/scoring-config.ts)
 */
...
const DEFAULT_DIMENSION_WEIGHTS: Record<number, number> = SCORING_CONFIG.dimensionWeights;

const DEFAULT_COMPOSITE_WEIGHTS = {
  weightedDim: SCORING_CONFIG.compositeWeights.weightedDim,
  depth: 0,
  maturity: SCORING_CONFIG.compositeWeights.maturity,
  breadth: SCORING_CONFIG.compositeWeights.breadth,
};

// Default blend weights for dimensions with follow-up questions
const DEFAULT_BLEND_WEIGHTS = SCORING_CONFIG.blendWeights;

const DIMENSION_NAMES: Record<number, string> = SCORING_CONFIG.dimensionNames;

const DIMENSION_ORDER = [4, 8, 3, 2, 13, 6, 1, 5, 7, 9, 10, 11, 12];

const POINTS = SCORING_CONFIG.points;
const INSUFFICIENT_DATA_THRESHOLD = SCORING_CONFIG.insufficientDataThreshold;
