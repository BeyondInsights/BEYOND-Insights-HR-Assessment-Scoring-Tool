...
export default function Dimension3Page() {
  ...
  const hasExistingGridData = ans['d3a'] && typeof ans['d3a'] === 'object' && Object.keys(ans['d3a']).length > 0;
                ...
                <div className="flex items-center justify-between">
                  <div>
                    <p className="text-sm font-semibold text-blue-900">
                      Progress: {Object.keys(ans.d3a || {}).length} of {D3A_ITEMS.length} elements rated
                    </p>
                    <p className="text-xs text-blue-700 mt-1">
                      {Object.keys(ans.d3a || {}).length === D3A_ITEMS.length 
                        ? '✓ All elements completed!' 
                        : `${D3A_ITEMS.length - Object.keys(ans.d3a || {}).length} elements remaining`}
                    </p>
                  </div>
