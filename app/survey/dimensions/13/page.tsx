...
export default function Dimension13Page() {
  ...
  // Use the progressive status grid hook for d13a items
  const {
    items: D13A_ITEMS,
    currentItemIndex,
    isTransitioning,
      ...
      <div className="min-h-screen bg-gradient-to-b from-gray-50 to-white flex flex-col">
        ...
        <main className="max-w-4xl mx-auto px-6 py-8 flex-1">
          <DimensionSummaryView
            dimensionNumber={13}
            dimensionName="Communication & Awareness"
            gridData={ans['d13a'] || {}}
            allAnswers={ans}
        ...
        <div className="mb-6">
          <div className="flex items-center justify-between mb-2">
            <span className="text-sm text-gray-600">
              Dimension 13: Communication & Awareness</span>
          </div>
              ...
              <div className="mb-6">
                <div className="flex items-center justify-between">
                  <span className="text-lg font-bold text-gray-800">
                    Element {currentItemIndex + 1} of {D13A_ITEMS.length}
                  </span>
