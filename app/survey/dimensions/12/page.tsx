...
export default function Dimension12Page() {
  ...
  useEffect(() => {
    ...
    const firmData = localStorage.getItem("firmographics_data");
    if (firmData) {
      const parsed = JSON.parse(firmData);
  ...
  const setField = (field: string, value: any) => {
    setAns((prev: any) => ({ ...prev, [field]: value }));
  };
  ...
  const setStatus = (item: string, status: string) => {
    ...
    setTimeout(() => {
      ...
      const nextUnansweredIndex = D12A_ITEMS.findIndex(
        (itm) => !ans.d12a?.[itm] && itm !== item
      );
  ...
  // *** CORRECT D12 ITEMS FROM INSTRUMENT ***
  const D12A_ITEMS = [
      ...
      <main className="flex-1 max-w-5xl mx-auto px-4 py-8">
              ...
              <div className="bg-gray-50 p-6 rounded-lg border border-gray-200">
                ...
                <ul className="space-y-3 text-gray-700">
                  <li className="flex items-start">
                    ...
                    <span>
                      You'll see different measurement and improvement practices, one at a time
                    </span>
                  </li>
                  <li className="flex items-start">
                    <span className="text-blue-600 mr-2 mt-1">•</span>
                  ...
                  <li className="flex items-start">
                    <span className="text-blue-600 mr-2 mt-1">•</span>
                    <span>
                      After selecting a response, it will automatically advance to the next measurement
                    </span>
                  </li>
                  <li className="flex items-start">
                    <span className="text-blue-600 mr-2 mt-1">•</span>
            ...
            <div className="bg-gradient-to-r from-gray-900 to-gray-800 px-8 py-6 rounded-t-xl">
              <div className="flex justify-between items-start">
                <div className="flex-1">
                  ...
                  <p className="text-gray-300 text-sm">Measurement and program evolution</p>
                </div>
              </div>
            </div>
        ...
        {step === 2 && showD12aa && (
          <div className="bg-white p-6 rounded-lg shadow-sm">
            ...
            <p className="font-bold text-gray-900 mb-4">
              ...
              your organization{" "}
              <span className="text-blue-600 font-bold">currently measures / tracks</span>...?
            </p>
        ...
        {step === 3 && (
          <div className="bg-white p-6 rounded-lg shadow-sm">
            ...
            <p className="font-bold text-gray-900 mb-4">
              What other{" "}
              <span className="text-blue-600 font-bold">
                measurement or continuous improvement practices
              </span>{" "}
              does your organization use when considering workplace support programs for{" "}
              <span className="text-blue-600 font-bold">
                employees managing cancer or other serious health conditions
              </span>
              ?
            </p>
        ...
        {step === 4 && showD12_1 && (
          <div className="bg-white p-6 rounded-lg shadow-sm">
            ...
            <p className="font-bold text-gray-900 mb-4">
              Do you review{" "}
              <span className="text-blue-600 font-bold">individual employee experiences</span> (not
              just aggregate data){" "}
              <span className="text-blue-600 font-bold">to identify potential improvements</span> to
              your programs for{" "}
              <span className="text-blue-600 font-bold">
                employees managing cancer or other serious health conditions
              </span>
        ...
        {step === 5 && showD12_2 && (
          <div className="bg-white p-6 rounded-lg shadow-sm">
            ...
            <p className="font-bold text-gray-900 mb-4">
              <span className="text-blue-600 font-bold">Over the past 2 years</span>, have{" "}
              <span className="text-blue-600 font-bold">individual</span> employee experiences led to{" "}
              <span className="text-blue-600 font-bold">specific changes</span> to your programs for{" "}
              <span className="text-blue-600 font-bold">
                employees managing cancer or other serious health conditions
              </span>
              ?
        ...
        {step === 6 && (
          <div className="bg-white p-8 rounded-lg shadow-sm text-center">
            ...
            <h2 className="text-2xl font-bold text-gray-900 mb-3">Dimension 12 Complete!</h2>
