...
import { d1Schema } from './d1-medical-leave'  // No dimensions/ folder
import { d2Schema } from './d2-insurance'
import { d3Schema } from './d3-manager'
import { d4Schema } from './d4-navigation'
import { d5Schema } from './d5-accommodations'
import { d6Schema } from './d6-culture'
import { d7Schema } from './d7-career'
import { d8Schema } from './d8-work-continuation'
import { d9Schema } from './d9-executive'
import { d10Schema } from './d10-caregiver'
import { d11Schema } from './d11-prevention'
import { d12Schema } from './d12-continuous'
import { d13Schema } from './d13-communication'
  ...
  sections: [
    ...
    },
    {
      ...
      subsections: [
        ...
        { id: 'd4', title: 'Specialized Resources', schema: d4Schema },
