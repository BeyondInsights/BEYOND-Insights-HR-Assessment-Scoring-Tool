  ...
  const validateStep = () => {
    switch (step) {
      ...
      case 8: // Benefits eligibility
        ...
        // SKIP C4 (excluded groups) if C3 = "All employees (100%)"
        if (ans.c3 !== "All employees (100%)") {
          ...
          if (ans.c4.includes("Some other group (specify):") && !ans.c4_other?.trim())
          ...
          <div className="space-y-10 bg-white p-6 rounded-lg shadow-sm">
            ...
            <div>
              ...
              <input
                ...
                onBlur={() => markTouched("s1")}
                className={`w-32 px-4 py-2 border-2 rounded-lg ${
                  touched.s1 && (!ans.s1 || parseInt(ans.s1) < 1900 || parseInt(ans.s1) > 2010)
              ...
              {touched.s1 && (!ans.s1 || parseInt(ans.s1) < 1900 || parseInt(ans.s1) > 2010) && (
                <p className="mt-2 text-sm text-red-600 flex items-center gap-1">
                  ...
                  Please enter a valid birth year (1900-2010)
                </p>
              )}
            </div>
              ...
              <div className={`border-2 rounded-lg p-4 ${
                ...
                {touched.s4a && !ans.s4a && (
                  <p className="mt-3 text-sm text-red-600 flex items-center gap-1">
                    ...
                    Please select your department / function
                  </p>
                )}
              </div>
            </div>
        ...
        {step === 3 && (
          <div className="space-y-10 bg-white p-6 rounded-lg shadow-sm">
            ...
            <div>
              ...
              <div className={`border-2 rounded-lg p-4 ${
                touched.s6 && (!ans.s6 || ans.s6.length === 0)
                  ? 'border-red-500 bg-red-50'
                  : 'border-gray-200 bg-white'
              }`}>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-2">
                ...
                {touched.s6 && (!ans.s6 || ans.s6.length === 0) && (
                  <p className="mt-3 text-sm text-red-600 flex items-center gap-1">
                    ...
                    Please select your areas of responsibility
                  </p>
                )}
              </div>
            </div>
              ...
              <div className={`border-2 rounded-lg p-4 ${
                ...
                {touched.s7 && !ans.s7 && (
                  <p className="mt-3 text-sm text-red-600 flex items-center gap-1">
                    ...
                    Please select your level of influence
                  </p>
                )}
              </div>
            </div>
          ...
          <div className="space-y-10 bg-white p-6 rounded-lg shadow-sm">
            ...
            <div>
              ...
              <select
                ...
                onBlur={() => markTouched("s9")}
                className={`w-full max-w-md px-4 py-3 border-2 rounded-lg focus:outline-none text-sm md:text-base ${
                  touched.s9 && !ans.s9
                    ? 'border-red-500 bg-red-50'
              ...
              {touched.s9 && !ans.s9 && (
                <p className="mt-2 text-sm text-red-600 flex items-center gap-1">
                  ...
                  Please select your headquarters country
                </p>
              )}
            </div>
              ...
              <div className={`border-2 rounded-lg p-4 ${
                ...
                {touched.s9a && !ans.s9a && (
                  <p className="mt-3 text-sm text-red-600 flex items-center gap-1">
                    ...
                    Please select number of other countries
                  </p>
                )}
              </div>
            </div>
          ...
          <div className="space-y-10 bg-white p-6 rounded-lg shadow-sm">
              ...
              <div className={`border-2 rounded-lg p-4 ${
                ...
                {touched.c3 && !ans.c3 && (
                  <p className="mt-3 text-sm text-red-600 flex items-center gap-1">
                    ...
                    Please select workforce eligibility percentage
                  </p>
                )}
              </div>
            </div>
            ...
            {ans.c3 && ans.c3 !== "All employees (100%)" && (
              <div>
                ...
                <div className={`border-2 rounded-lg p-4 ${
                  touched.c4 && (!ans.c4 || ans.c4.length === 0)
                    ? 'border-red-500 bg-red-50'
                    : 'border-gray-200 bg-white'
                }`}>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-2">
                    {C4_EXCLUDED.map(opt => {
                      ...
                      const isOther = opt === "Some other group (specify):";
                  ...
                  {touched.c4 && (!ans.c4 || ans.c4.length === 0) && (
                    <p className="mt-3 text-sm text-red-600 flex items-center gap-1">
                      ...
                      Please select which groups are excluded (or select 'None')
                    </p>
                  )}
                </div>
              </div>
              ...
              <div className={`border-2 rounded-lg p-4 ${
                ...
                {touched.c6 && !ans.c6 && (
                  <p className="mt-3 text-sm text-red-600 flex items-center gap-1">
                    ...
                    Please select remote / hybrid work approach
                  </p>
                )}
              </div>
            </div>
