...
const DIMENSION_DEFINITIONS: Record<string, string> = {
  ...
  "Specialized Resources": "Access to care coordinators, patient advocates, benefits specialists, and expert resources that help employees navigate the healthcare system, understand their benefits, and connect with appropriate support services.",
