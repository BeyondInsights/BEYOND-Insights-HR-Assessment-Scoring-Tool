...
const BTN_TEXT = "text-left text-sm md:text-base font-semibold"; // normal = bold
const OTHER_TEXT = "text-left text-sm md:text-base font-normal"; // Other = normal
              ...
              <div className={`grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 items-stretch ${ROW.med}`}>
                {S6.map((opt) => (
                  <MultiOptionButton
                    ...
                    className={opt === "None of these" ? OTHER_TEXT : BTN_TEXT}
                  />
                ))}
              </div>
            </div>
