      ...
      <div className="bg-white shadow-sm">
        <div className="max-w-7xl mx-auto px-6 py-6">
          <div className="flex items-center justify-between">
            ...
            <a
              href="/admin/scoring"
              className="px-5 py-3 bg-gradient-to-r from-indigo-600 to-indigo-700 text-white rounded-xl font-bold shadow-lg hover:from-indigo-700 hover:to-indigo-800 transition-all flex items-center gap-2"
            >
